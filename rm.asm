...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 7d 09 00 	movl   $0x97d,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40a:	0f b6 80 cc 09 00 00 	movzbl 0x9cc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 568:	75 27                	jne    591 <printf+0x120>
          s = "(null)";
 56a:	c7 45 e4 96 09 00 00 	movl   $0x996,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 637:	a1 e8 09 00 00       	mov    0x9e8,%eax
...
free(void *ap)
{
 ...
 6f8:	a3 e8 09 00 00       	mov    %eax,0x9e8
}
 6fd:	c9                   	leave  
 6fe:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 74b:	e8 d8 fe ff ff       	call   628 <free>
  return freep;
 750:	a1 e8 09 00 00       	mov    0x9e8,%eax
}
 755:	c9                   	leave  
 756:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 769:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 76c:	a1 e8 09 00 00       	mov    0x9e8,%eax
 771:	89 45 f0             	mov    %eax,-0x10(%ebp)
 774:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 778:	75 23                	jne    79d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 77a:	c7 45 f0 e0 09 00 00 	movl   $0x9e0,-0x10(%ebp)
 781:	8b 45 f0             	mov    -0x10(%ebp),%eax
 784:	a3 e8 09 00 00       	mov    %eax,0x9e8
 789:	a1 e8 09 00 00       	mov    0x9e8,%eax
 78e:	a3 e0 09 00 00       	mov    %eax,0x9e0
    base.s.size = 0;
 793:	c7 05 e4 09 00 00 00 	movl   $0x0,0x9e4
 79a:	00 00 00 
  }
 ...
 7f0:	a3 e8 09 00 00       	mov    %eax,0x9e8
      return (void*)(p + 1);
 ...
 7fb:	eb 38                	jmp    835 <malloc+0xde>
    ...
    if(p == freep)
 7fd:	a1 e8 09 00 00       	mov    0x9e8,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8dc:	c7 44 24 04 9d 09 00 	movl   $0x99d,0x4(%esp)
 8e3:	00 
 ...
 922:	c7 44 24 04 ab 09 00 	movl   $0x9ab,0x4(%esp)
 929:	00 
 ...
 94e:	c7 44 24 04 b8 09 00 	movl   $0x9b8,0x4(%esp)
 955:	00 
