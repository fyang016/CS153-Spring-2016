...
wc(int fd, char *name)
{
  ...
  32:	0f b6 80 60 0b 00 00 	movzbl 0xb60(%eax),%eax
  39:	3c 0a                	cmp    $0xa,%al
  ...
  44:	0f b6 80 60 0b 00 00 	movzbl 0xb60(%eax),%eax
  4b:	0f be c0             	movsbl %al,%eax
  4e:	89 44 24 04          	mov    %eax,0x4(%esp)
  52:	c7 04 24 a9 0a 00 00 	movl   $0xaa9,(%esp)
  ...
  8f:	00 
  90:	c7 44 24 04 60 0b 00 	movl   $0xb60,0x4(%esp)
  97:	00 
  ...
  b6:	c7 44 24 04 af 0a 00 	movl   $0xaaf,0x4(%esp)
  bd:	00 
  be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c5:	e8 e7 04 00 00       	call   5b1 <printf>
    exit();
  ...
  eb:	c7 44 24 04 bf 0a 00 	movl   $0xabf,0x4(%esp)
  f2:	00 
  f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fa:	e8 b2 04 00 00       	call   5b1 <printf>
}
  ff:	c9                   	leave  
 100:	c3                   	ret    
...
main(int argc, char *argv[])
{
 ...
 10e:	7f 19                	jg     129 <main+0x28>
    wc(0, "");
 110:	c7 44 24 04 cc 0a 00 	movl   $0xacc,0x4(%esp)
 117:	00 
 ...
 16a:	c7 44 24 04 cd 0a 00 	movl   $0xacd,0x4(%esp)
 171:	00 
 172:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 179:	e8 33 04 00 00       	call   5b1 <printf>
      exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 507:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 50e:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 512:	74 17                	je     52b <printint+0x2b>
 514:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 518:	79 11                	jns    52b <printint+0x2b>
    neg = 1;
 51a:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 ...
 526:	89 45 f4             	mov    %eax,-0xc(%ebp)
  ...
  neg = 0;
  if(sgn && xx < 0){
 529:	eb 06                	jmp    531 <printint+0x31>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 531:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  do{
    buf[i++] = digits[x % base];
 538:	8b 4d ec             	mov    -0x14(%ebp),%ecx
 53b:	8b 5d 10             	mov    0x10(%ebp),%ebx
 53e:	8b 45 f4             	mov    -0xc(%ebp),%eax
 541:	ba 00 00 00 00       	mov    $0x0,%edx
 546:	f7 f3                	div    %ebx
 548:	89 d0                	mov    %edx,%eax
 54a:	0f b6 80 14 0b 00 00 	movzbl 0xb14(%eax),%eax
 551:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
 555:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  }while((x /= base) != 0);
 559:	8b 45 10             	mov    0x10(%ebp),%eax
 55c:	89 45 d4             	mov    %eax,-0x2c(%ebp)
 ...
 571:	75 c5                	jne    538 <printint+0x38>
  if(neg)
 573:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 577:	74 28                	je     5a1 <printint+0xa1>
    buf[i++] = '-';
 ...
 59c:	e8 37 ff ff ff       	call   4d8 <putc>
  ...
  while(--i >= 0)
 5a1:	83 6d ec 01          	subl   $0x1,-0x14(%ebp)
 5a5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 5a9:	79 dc                	jns    587 <printint+0x87>
    putc(fd, buf[i]);
}
 5ab:	83 c4 44             	add    $0x44,%esp
 5ae:	5b                   	pop    %ebx
 5af:	5d                   	pop    %ebp
 5b0:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 5ce:	e9 7e 01 00 00       	jmp    751 <printf+0x1a0>
    c = fmt[i] & 0xff;
 ...
 5e7:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(state == 0){
 5ea:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 5ee:	75 2c                	jne    61c <printf+0x6b>
      if(c == '%'){
 5f0:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
 5f4:	75 0c                	jne    602 <printf+0x51>
        state = '%';
 5f6:	c7 45 f0 25 00 00 00 	movl   $0x25,-0x10(%ebp)
 5fd:	e9 4b 01 00 00       	jmp    74d <printf+0x19c>
      } else {
        putc(fd, c);
 ...
 612:	e8 c1 fe ff ff       	call   4d8 <putc>
 617:	e9 31 01 00 00       	jmp    74d <printf+0x19c>
      }
    } else if(state == '%'){
 61c:	83 7d f0 25          	cmpl   $0x25,-0x10(%ebp)
 620:	0f 85 27 01 00 00    	jne    74d <printf+0x19c>
      if(c == 'd'){
 626:	83 7d e8 64          	cmpl   $0x64,-0x18(%ebp)
 62a:	75 2d                	jne    659 <printf+0xa8>
        printint(fd, *ap, 10, 1);
 ...
 64b:	e8 b0 fe ff ff       	call   500 <printint>
        ap++;
 650:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
 654:	e9 ed 00 00 00       	jmp    746 <printf+0x195>
      } else if(c == 'x' || c == 'p'){
 659:	83 7d e8 78          	cmpl   $0x78,-0x18(%ebp)
 65d:	74 06                	je     665 <printf+0xb4>
 65f:	83 7d e8 70          	cmpl   $0x70,-0x18(%ebp)
 663:	75 2d                	jne    692 <printf+0xe1>
        printint(fd, *ap, 16, 0);
 ...
 684:	e8 77 fe ff ff       	call   500 <printint>
        ap++;
 689:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
      }
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
 ...
 68d:	e9 b4 00 00 00       	jmp    746 <printf+0x195>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 692:	83 7d e8 73          	cmpl   $0x73,-0x18(%ebp)
 696:	75 46                	jne    6de <printf+0x12d>
        s = (char*)*ap;
 698:	8b 45 f4             	mov    -0xc(%ebp),%eax
 69b:	8b 00                	mov    (%eax),%eax
 69d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        ap++;
 6a0:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
        if(s == 0)
 6a4:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
 6a8:	75 27                	jne    6d1 <printf+0x120>
          s = "(null)";
 6aa:	c7 45 e4 e1 0a 00 00 	movl   $0xae1,-0x1c(%ebp)
        while(*s != 0){
 6b1:	eb 1f                	jmp    6d2 <printf+0x121>
          putc(fd, *s);
 ...
 6c6:	e8 0d fe ff ff       	call   4d8 <putc>
          s++;
 6cb:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
 6cf:	eb 01                	jmp    6d2 <printf+0x121>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 6da:	75 d7                	jne    6b3 <printf+0x102>
 6dc:	eb 68                	jmp    746 <printf+0x195>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 6de:	83 7d e8 63          	cmpl   $0x63,-0x18(%ebp)
 6e2:	75 1d                	jne    701 <printf+0x150>
        putc(fd, *ap);
 ...
 6f6:	e8 dd fd ff ff       	call   4d8 <putc>
        ap++;
 6fb:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
 6ff:	eb 45                	jmp    746 <printf+0x195>
      } else if(c == '%'){
 701:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
 705:	75 17                	jne    71e <printf+0x16d>
        putc(fd, c);
 ...
 717:	e8 bc fd ff ff       	call   4d8 <putc>
 71c:	eb 28                	jmp    746 <printf+0x195>
      } else {
 ...
 72c:	e8 a7 fd ff ff       	call   4d8 <putc>
        putc(fd, c);
 ...
 741:	e8 92 fd ff ff       	call   4d8 <putc>
      }
      state = 0;
 ...
 757:	8d 04 02             	lea    (%edx,%eax,1),%eax
 75a:	0f b6 00             	movzbl (%eax),%eax
 75d:	84 c0                	test   %al,%al
 75f:	0f 85 6e fe ff ff    	jne    5d3 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 805:	03 45 fc             	add    -0x4(%ebp),%eax
 808:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 80b:	75 20                	jne    82d <free+0xc5>
    p->s.size += bp->s.size;
 ...
 838:	a3 48 0b 00 00       	mov    %eax,0xb48
}
 83d:	c9                   	leave  
 83e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 85e:	e8 4d fc ff ff       	call   4b0 <sbrk>
 ...
 88b:	e8 d8 fe ff ff       	call   768 <free>
  return freep;
 890:	a1 48 0b 00 00       	mov    0xb48,%eax
}
 895:	c9                   	leave  
 896:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8a9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 8ac:	a1 48 0b 00 00       	mov    0xb48,%eax
 8b1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8b4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8b8:	75 23                	jne    8dd <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8ba:	c7 45 f0 40 0b 00 00 	movl   $0xb40,-0x10(%ebp)
 8c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8c4:	a3 48 0b 00 00       	mov    %eax,0xb48
 8c9:	a1 48 0b 00 00       	mov    0xb48,%eax
 8ce:	a3 40 0b 00 00       	mov    %eax,0xb40
    base.s.size = 0;
 8d3:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 8da:	00 00 00 
  }
 ...
 8e2:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(p->s.size >= nunits){
 8e5:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8e8:	8b 40 04             	mov    0x4(%eax),%eax
 8eb:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 ...
 921:	01 45 ec             	add    %eax,-0x14(%ebp)
        p->s.size = nunits;
 924:	8b 45 ec             	mov    -0x14(%ebp),%eax
 927:	8b 55 f4             	mov    -0xc(%ebp),%edx
 92a:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 92d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 930:	a3 48 0b 00 00       	mov    %eax,0xb48
      return (void*)(p + 1);
 ...
 93b:	eb 38                	jmp    975 <malloc+0xde>
    ...
    if(p == freep)
 93d:	a1 48 0b 00 00       	mov    0xb48,%eax
 ...
 955:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
...
xchg(volatile uint *addr, uint newval)
{
 ...
 984:	8b 4d 08             	mov    0x8(%ebp),%ecx
 987:	f0 87 02             	lock xchg %eax,(%edx)
...
void lock_init(lock_t *lock){
 ...
 998:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 99e:	5d                   	pop    %ebp
 99f:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 9a9:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
 9b0:	00 
 9b1:	89 04 24             	mov    %eax,(%esp)
 9b4:	e8 bf ff ff ff       	call   978 <xchg>
 9b9:	85 c0                	test   %eax,%eax
 9bb:	75 e9                	jne    9a6 <lock_acquire+0x6>
}
 9bd:	c9                   	leave  
 9be:	c3                   	ret    

000009bf <lock_release>:
void lock_release(lock_t *lock){
 ...
 9c8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
 9cf:	00 
 9d0:	89 04 24             	mov    %eax,(%esp)
 9d3:	e8 a0 ff ff ff       	call   978 <xchg>
}
 9d8:	c9                   	leave  
 9d9:	c3                   	ret    

000009da <thread_create>:
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 9e0:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
 9e7:	e8 ab fe ff ff       	call   897 <malloc>
 ...
 9f8:	25 ff 0f 00 00       	and    $0xfff,%eax
 9fd:	85 c0                	test   %eax,%eax
 9ff:	74 15                	je     a16 <thread_create+0x3c>
        stack = stack + (4096 - (uint)stack % 4096);
 a01:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a04:	89 c2                	mov    %eax,%edx
 a06:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 a0c:	b8 00 10 00 00       	mov    $0x1000,%eax
 a11:	29 d0                	sub    %edx,%eax
 a13:	01 45 f0             	add    %eax,-0x10(%ebp)
    }
    if (stack == 0){
 a16:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a1a:	75 1b                	jne    a37 <thread_create+0x5d>

        printf(1,"malloc fail \n");
 a1c:	c7 44 24 04 e8 0a 00 	movl   $0xae8,0x4(%esp)
 a23:	00 
 a24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a2b:	e8 81 fb ff ff       	call   5b1 <printf>
        return 0;
 a30:	b8 00 00 00 00       	mov    $0x0,%eax
 a35:	eb 70                	jmp    aa7 <thread_create+0xcd>
    }
 ...
 a49:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
 a50:	00 
 a51:	89 04 24             	mov    %eax,(%esp)
 a54:	e8 6f fa ff ff       	call   4c8 <clone>
 a59:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(tid < 0){
 a5c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a60:	79 1b                	jns    a7d <thread_create+0xa3>
        printf(1,"clone fails\n");
 a62:	c7 44 24 04 f6 0a 00 	movl   $0xaf6,0x4(%esp)
 a69:	00 
 a6a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a71:	e8 3b fb ff ff       	call   5b1 <printf>
        return 0;
 a76:	b8 00 00 00 00       	mov    $0x0,%eax
 a7b:	eb 2a                	jmp    aa7 <thread_create+0xcd>
    }
    if(tid > 0){
 a7d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a81:	7e 05                	jle    a88 <thread_create+0xae>
        return garbage_stack;
 a83:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a86:	eb 1f                	jmp    aa7 <thread_create+0xcd>
    }
    if(tid == 0){
 a88:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a8c:	75 14                	jne    aa2 <thread_create+0xc8>
        printf(1,"tid = 0 return \n");
 a8e:	c7 44 24 04 03 0b 00 	movl   $0xb03,0x4(%esp)
 a95:	00 
 a96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a9d:	e8 0f fb ff ff       	call   5b1 <printf>
    }
//    wait();
//    free(garbage_stack);
