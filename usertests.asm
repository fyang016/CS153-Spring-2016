...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 ac 59 00 00       	mov    0x59ac,%eax
       b:	c7 44 24 04 b6 42 00 	movl   $0x42b6,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 8a 3d 00 00       	call   3da5 <printf>
  fd = open("echo", 0);
      1b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      22:	00 
      23:	c7 04 24 a0 42 00 00 	movl   $0x42a0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 ac 59 00 00       	mov    0x59ac,%eax
      3d:	c7 44 24 04 c1 42 00 	movl   $0x42c1,0x4(%esp)
      44:	00 
      45:	89 04 24             	mov    %eax,(%esp)
      48:	e8 58 3d 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 d4 42 00 00 	movl   $0x42d4,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 ac 59 00 00       	mov    0x59ac,%eax
      7f:	c7 44 24 04 e1 42 00 	movl   $0x42e1,0x4(%esp)
      86:	00 
      87:	89 04 24             	mov    %eax,(%esp)
      8a:	e8 16 3d 00 00       	call   3da5 <printf>
    exit();
      8f:	e8 88 3b 00 00       	call   3c1c <exit>
  }
  printf(stdout, "open test ok\n");
      94:	a1 ac 59 00 00       	mov    0x59ac,%eax
      99:	c7 44 24 04 ff 42 00 	movl   $0x42ff,0x4(%esp)
      a0:	00 
      a1:	89 04 24             	mov    %eax,(%esp)
      a4:	e8 fc 3c 00 00       	call   3da5 <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 ac 59 00 00       	mov    0x59ac,%eax
      b6:	c7 44 24 04 0d 43 00 	movl   $0x430d,0x4(%esp)
      bd:	00 
      be:	89 04 24             	mov    %eax,(%esp)
      c1:	e8 df 3c 00 00       	call   3da5 <printf>
  fd = open("small", O_CREATE|O_RDWR);
      c6:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
      cd:	00 
      ce:	c7 04 24 1e 43 00 00 	movl   $0x431e,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 ac 59 00 00       	mov    0x59ac,%eax
      e8:	c7 44 24 04 24 43 00 	movl   $0x4324,0x4(%esp)
      ef:	00 
      f0:	89 04 24             	mov    %eax,(%esp)
      f3:	e8 ad 3c 00 00       	call   3da5 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 ac 59 00 00       	mov    0x59ac,%eax
     109:	c7 44 24 04 3f 43 00 	movl   $0x433f,0x4(%esp)
     110:	00 
     111:	89 04 24             	mov    %eax,(%esp)
     114:	e8 8c 3c 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 5b 43 00 	movl   $0x435b,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 ac 59 00 00       	mov    0x59ac,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 68 43 00 	movl   $0x4368,0x4(%esp)
     151:	00 
     152:	89 04 24             	mov    %eax,(%esp)
     155:	e8 4b 3c 00 00       	call   3da5 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 8c 43 00 	movl   $0x438c,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 ac 59 00 00       	mov    0x59ac,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 98 43 00 	movl   $0x4398,0x4(%esp)
     192:	00 
     193:	89 04 24             	mov    %eax,(%esp)
     196:	e8 0a 3c 00 00       	call   3da5 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 ac 59 00 00       	mov    0x59ac,%eax
     1b3:	c7 44 24 04 bc 43 00 	movl   $0x43bc,0x4(%esp)
     1ba:	00 
     1bb:	89 04 24             	mov    %eax,(%esp)
     1be:	e8 e2 3b 00 00       	call   3da5 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 1e 43 00 00 	movl   $0x431e,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 ac 59 00 00       	mov    0x59ac,%eax
     1f0:	c7 44 24 04 c7 43 00 	movl   $0x43c7,0x4(%esp)
     1f7:	00 
     1f8:	89 04 24             	mov    %eax,(%esp)
     1fb:	e8 a5 3b 00 00       	call   3da5 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     207:	00 
     208:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
     20f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 ac 59 00 00       	mov    0x59ac,%eax
     22e:	c7 44 24 04 e0 43 00 	movl   $0x43e0,0x4(%esp)
     235:	00 
     236:	89 04 24             	mov    %eax,(%esp)
     239:	e8 67 3b 00 00       	call   3da5 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 ac 59 00 00       	mov    0x59ac,%eax
     248:	c7 44 24 04 fb 43 00 	movl   $0x43fb,0x4(%esp)
     24f:	00 
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 4d 3b 00 00       	call   3da5 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 1e 43 00 00 	movl   $0x431e,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 ac 59 00 00       	mov    0x59ac,%eax
     27a:	c7 44 24 04 0e 44 00 	movl   $0x440e,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 1b 3b 00 00       	call   3da5 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 ac 59 00 00       	mov    0x59ac,%eax
     294:	c7 44 24 04 1b 44 00 	movl   $0x441b,0x4(%esp)
     29b:	00 
     29c:	89 04 24             	mov    %eax,(%esp)
     29f:	e8 01 3b 00 00       	call   3da5 <printf>
    exit();
     2a4:	e8 73 39 00 00       	call   3c1c <exit>
  }
  printf(stdout, "small file test ok\n");
     2a9:	a1 ac 59 00 00       	mov    0x59ac,%eax
     2ae:	c7 44 24 04 30 44 00 	movl   $0x4430,0x4(%esp)
     2b5:	00 
     2b6:	89 04 24             	mov    %eax,(%esp)
     2b9:	e8 e7 3a 00 00       	call   3da5 <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 ac 59 00 00       	mov    0x59ac,%eax
     2cb:	c7 44 24 04 44 44 00 	movl   $0x4444,0x4(%esp)
     2d2:	00 
     2d3:	89 04 24             	mov    %eax,(%esp)
     2d6:	e8 ca 3a 00 00       	call   3da5 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     2db:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     2e2:	00 
     2e3:	c7 04 24 54 44 00 00 	movl   $0x4454,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 ac 59 00 00       	mov    0x59ac,%eax
     2fd:	c7 44 24 04 58 44 00 	movl   $0x4458,0x4(%esp)
     304:	00 
     305:	89 04 24             	mov    %eax,(%esp)
     308:	e8 98 3a 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 ac 59 00 00       	mov    0x59ac,%eax
     34c:	8b 55 ec             	mov    -0x14(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 72 44 00 	movl   $0x4472,0x4(%esp)
     35a:	00 
     35b:	89 04 24             	mov    %eax,(%esp)
     35e:	e8 42 3a 00 00       	call   3da5 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 54 44 00 00 	movl   $0x4454,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 ac 59 00 00       	mov    0x59ac,%eax
     3a3:	c7 44 24 04 90 44 00 	movl   $0x4490,0x4(%esp)
     3aa:	00 
     3ab:	89 04 24             	mov    %eax,(%esp)
     3ae:	e8 f2 39 00 00       	call   3da5 <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c6:	00 
     3c7:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
     3ce:	00 
    ...
    if(i == 0){
     ...
     3f0:	a1 ac 59 00 00       	mov    0x59ac,%eax
     3f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 a9 44 00 	movl   $0x44a9,0x4(%esp)
     403:	00 
     404:	89 04 24             	mov    %eax,(%esp)
     407:	e8 99 39 00 00       	call   3da5 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 54 44 00 00 	movl   $0x4454,(%esp)
     48f:	e8 d8 37 00 00       	call   3c6c <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 ac 59 00 00       	mov    0x59ac,%eax
     49d:	c7 44 24 04 f8 44 00 	movl   $0x44f8,0x4(%esp)
     4a4:	00 
     4a5:	89 04 24             	mov    %eax,(%esp)
     4a8:	e8 f8 38 00 00       	call   3da5 <printf>
    exit();
     4ad:	e8 6a 37 00 00       	call   3c1c <exit>
  }
  printf(stdout, "big files ok\n");
     4b2:	a1 ac 59 00 00       	mov    0x59ac,%eax
     4b7:	c7 44 24 04 0b 45 00 	movl   $0x450b,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 de 38 00 00       	call   3da5 <printf>
}
     4c7:	c9                   	leave  
     4c8:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 ac 59 00 00       	mov    0x59ac,%eax
     4d4:	c7 44 24 04 1c 45 00 	movl   $0x451c,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 c1 38 00 00       	call   3da5 <printf>

  name[0] = 'a';
     4e4:	c6 05 a0 a1 00 00 61 	movb   $0x61,0xa1a0
  name[2] = '\0';
     4eb:	c6 05 a2 a1 00 00 00 	movb   $0x0,0xa1a2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     501:	a2 a1 a1 00 00       	mov    %al,0xa1a1
    fd = open(name, O_CREATE|O_RDWR);
     506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50d:	00 
     50e:	c7 04 24 a0 a1 00 00 	movl   $0xa1a0,(%esp)
  ...
  name[0] = 'a';
     532:	c6 05 a0 a1 00 00 61 	movb   $0x61,0xa1a0
  name[2] = '\0';
     539:	c6 05 a2 a1 00 00 00 	movb   $0x0,0xa1a2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     54f:	a2 a1 a1 00 00       	mov    %al,0xa1a1
    unlink(name);
     554:	c7 04 24 a0 a1 00 00 	movl   $0xa1a0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 ac 59 00 00       	mov    0x59ac,%eax
     56f:	c7 44 24 04 44 45 00 	movl   $0x4544,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 26 38 00 00       	call   3da5 <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 ac 59 00 00       	mov    0x59ac,%eax
     58c:	c7 44 24 04 6a 45 00 	movl   $0x456a,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 09 38 00 00       	call   3da5 <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 76 45 00 00 	movl   $0x4576,(%esp)
     5a3:	e8 dc 36 00 00       	call   3c84 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 ac 59 00 00       	mov    0x59ac,%eax
     5b1:	c7 44 24 04 7b 45 00 	movl   $0x457b,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 e4 37 00 00       	call   3da5 <printf>
    exit();
     5c1:	e8 56 36 00 00       	call   3c1c <exit>
  }

  if(chdir("dir0") < 0){
     5c6:	c7 04 24 76 45 00 00 	movl   $0x4576,(%esp)
     5cd:	e8 ba 36 00 00       	call   3c8c <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 ac 59 00 00       	mov    0x59ac,%eax
     5db:	c7 44 24 04 89 45 00 	movl   $0x4589,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 ba 37 00 00       	call   3da5 <printf>
    exit();
     5eb:	e8 2c 36 00 00       	call   3c1c <exit>
  }

  if(chdir("..") < 0){
     5f0:	c7 04 24 9c 45 00 00 	movl   $0x459c,(%esp)
     5f7:	e8 90 36 00 00       	call   3c8c <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 ac 59 00 00       	mov    0x59ac,%eax
     605:	c7 44 24 04 9f 45 00 	movl   $0x459f,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 90 37 00 00       	call   3da5 <printf>
    exit();
     615:	e8 02 36 00 00       	call   3c1c <exit>
  }

  if(unlink("dir0") < 0){
     61a:	c7 04 24 76 45 00 00 	movl   $0x4576,(%esp)
     621:	e8 46 36 00 00       	call   3c6c <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 ac 59 00 00       	mov    0x59ac,%eax
     62f:	c7 44 24 04 b0 45 00 	movl   $0x45b0,0x4(%esp)
     636:	00 
     637:	89 04 24             	mov    %eax,(%esp)
     63a:	e8 66 37 00 00       	call   3da5 <printf>
    exit();
     63f:	e8 d8 35 00 00       	call   3c1c <exit>
  }
  printf(stdout, "mkdir test\n");
     644:	a1 ac 59 00 00       	mov    0x59ac,%eax
     649:	c7 44 24 04 6a 45 00 	movl   $0x456a,0x4(%esp)
     650:	00 
     651:	89 04 24             	mov    %eax,(%esp)
     654:	e8 4c 37 00 00       	call   3da5 <printf>
}
     659:	c9                   	leave  
     65a:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 ac 59 00 00       	mov    0x59ac,%eax
     666:	c7 44 24 04 c4 45 00 	movl   $0x45c4,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 2f 37 00 00       	call   3da5 <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 98 59 00 	movl   $0x5998,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 a0 42 00 00 	movl   $0x42a0,(%esp)
     685:	e8 ca 35 00 00       	call   3c54 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 ac 59 00 00       	mov    0x59ac,%eax
     693:	c7 44 24 04 cf 45 00 	movl   $0x45cf,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 02 37 00 00       	call   3da5 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 e1 45 00 	movl   $0x45e1,0x4(%esp)
     6c6:	00 
     6c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6ce:	e8 d2 36 00 00       	call   3da5 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     714:	88 90 a0 81 00 00    	mov    %dl,0x81a0(%eax)
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     735:	00 
     736:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
     73d:	00 
     ...
     74d:	c7 44 24 04 f0 45 00 	movl   $0x45f0,0x4(%esp)
     754:	00 
     755:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75c:	e8 44 36 00 00       	call   3da5 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7a6:	0f b6 80 a0 81 00 00 	movzbl 0x81a0(%eax),%eax
     ...
     7c5:	c7 44 24 04 fe 45 00 	movl   $0x45fe,0x4(%esp)
     7cc:	00 
     7cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d4:	e8 cc 35 00 00       	call   3da5 <printf>
          return;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     80e:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
     815:	00 
    ...
    if(total != 5 * 1033){
     ...
     83b:	c7 44 24 04 0c 46 00 	movl   $0x460c,0x4(%esp)
     842:	00 
     843:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84a:	e8 56 35 00 00       	call   3da5 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     864:	c7 44 24 04 23 46 00 	movl   $0x4623,0x4(%esp)
     86b:	00 
     86c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     873:	e8 2d 35 00 00       	call   3da5 <printf>
    ...
    printf(1, "fork() failed\n");
     87a:	c7 44 24 04 2d 46 00 	movl   $0x462d,0x4(%esp)
     881:	00 
     882:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     889:	e8 17 35 00 00       	call   3da5 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89b:	c7 44 24 04 3c 46 00 	movl   $0x463c,0x4(%esp)
     8a2:	00 
     8a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8aa:	e8 f6 34 00 00       	call   3da5 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     8fd:	00 
     8fe:	c7 44 24 04 46 46 00 	movl   $0x4646,0x4(%esp)
     905:	00 
     ...
     913:	c7 44 24 04 48 46 00 	movl   $0x4648,0x4(%esp)
     91a:	00 
     91b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     922:	e8 7e 34 00 00       	call   3da5 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     949:	00 
     94a:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
     951:	00 
    ...
    printf(1, "preempt read error");
     95f:	c7 44 24 04 5c 46 00 	movl   $0x465c,0x4(%esp)
     966:	00 
     967:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     96e:	e8 32 34 00 00       	call   3da5 <printf>
    return;
  ...
  printf(1, "kill... ");
     980:	c7 44 24 04 6f 46 00 	movl   $0x466f,0x4(%esp)
     987:	00 
     988:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     98f:	e8 11 34 00 00       	call   3da5 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b5:	c7 44 24 04 78 46 00 	movl   $0x4678,0x4(%esp)
     9bc:	00 
     9bd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c4:	e8 dc 33 00 00       	call   3da5 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9d8:	c7 44 24 04 81 46 00 	movl   $0x4681,0x4(%esp)
     9df:	00 
     9e0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9e7:	e8 b9 33 00 00       	call   3da5 <printf>
}
     9ec:	c9                   	leave  
     9ed:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a09:	79 16                	jns    a21 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0b:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     a12:	00 
     a13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1a:	e8 86 33 00 00       	call   3da5 <printf>
      return;
    ...
    if(pid){
     ...
     a31:	c7 44 24 04 9a 46 00 	movl   $0x469a,0x4(%esp)
     a38:	00 
     a39:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a40:	e8 60 33 00 00       	call   3da5 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a56:	c7 44 24 04 aa 46 00 	movl   $0x46aa,0x4(%esp)
     a5d:	00 
     a5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a65:	e8 3b 33 00 00       	call   3da5 <printf>
}
     a6a:	c9                   	leave  
     a6b:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a72:	c7 44 24 04 b7 46 00 	movl   $0x46b7,0x4(%esp)
     a79:	00 
     a7a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a81:	e8 1f 33 00 00       	call   3da5 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     abe:	e8 c8 35 00 00       	call   408b <malloc>
    ...
    while(m1){
     ...
     adc:	e8 7b 34 00 00       	call   3f5c <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b2c:	e8 2b 34 00 00       	call   3f5c <free>
    printf(1, "mem ok\n");
     b31:	c7 44 24 04 db 46 00 	movl   $0x46db,0x4(%esp)
     b38:	00 
     b39:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b40:	e8 60 32 00 00       	call   3da5 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b57:	c7 44 24 04 e3 46 00 	movl   $0x46e3,0x4(%esp)
     b5e:	00 
     b5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b66:	e8 3a 32 00 00       	call   3da5 <printf>

  unlink("sharedfd");
     b6b:	c7 04 24 f2 46 00 00 	movl   $0x46f2,(%esp)
     b72:	e8 f5 30 00 00       	call   3c6c <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b77:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b7e:	00 
     b7f:	c7 04 24 f2 46 00 00 	movl   $0x46f2,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b94:	c7 44 24 04 fc 46 00 	movl   $0x46fc,0x4(%esp)
     b9b:	00 
     b9c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba3:	e8 fd 31 00 00       	call   3da5 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c06:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
     c0d:	00 
     c0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c15:	e8 8b 31 00 00       	call   3da5 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4b:	00 
     c4c:	c7 04 24 f2 46 00 00 	movl   $0x46f2,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c61:	c7 44 24 04 48 47 00 	movl   $0x4748,0x4(%esp)
     c68:	00 
     c69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c70:	e8 30 31 00 00       	call   3da5 <printf>
    return;
  ...
  unlink("sharedfd");
     cec:	c7 04 24 f2 46 00 00 	movl   $0x46f2,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0a:	c7 44 24 04 73 47 00 	movl   $0x4773,0x4(%esp)
     d11:	00 
     d12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d19:	e8 87 30 00 00       	call   3da5 <printf>
        np++;
    }
  }
  close(fd);
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d2f:	c7 44 24 04 80 47 00 	movl   $0x4780,0x4(%esp)
     d36:	00 
     d37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d3e:	e8 62 30 00 00       	call   3da5 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d50:	c7 44 24 04 95 47 00 	movl   $0x4795,0x4(%esp)
     d57:	00 
     d58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d5f:	e8 41 30 00 00       	call   3da5 <printf>

  unlink("f1");
     d64:	c7 04 24 a4 47 00 00 	movl   $0x47a4,(%esp)
     d6b:	e8 fc 2e 00 00       	call   3c6c <unlink>
  unlink("f2");
     d70:	c7 04 24 a7 47 00 00 	movl   $0x47a7,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8a:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     d91:	00 
     d92:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d99:	e8 07 30 00 00       	call   3da5 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     da9:	b8 a4 47 00 00       	mov    $0x47a4,%eax
     dae:	eb 05                	jmp    db5 <twofiles+0x6b>
     db0:	b8 a7 47 00 00       	mov    $0x47a7,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd4:	c7 44 24 04 aa 47 00 	movl   $0x47aa,0x4(%esp)
     ddb:	00 
     ddc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de3:	e8 bd 2f 00 00       	call   3da5 <printf>
    exit();
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e0b:	c7 04 24 a0 81 00 00 	movl   $0x81a0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e27:	00 
     e28:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
     e2f:	00 
     ...
     e4e:	c7 44 24 04 b9 47 00 	movl   $0x47b9,0x4(%esp)
     e55:	00 
     e56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e5d:	e8 43 2f 00 00       	call   3da5 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     e9e:	b8 a4 47 00 00       	mov    $0x47a4,%eax
     ea3:	eb 05                	jmp    eaa <twofiles+0x160>
     ea5:	b8 a7 47 00 00       	mov    $0x47a7,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ed2:	0f b6 80 a0 81 00 00 	movzbl 0x81a0(%eax),%eax
     ...
     ef0:	74 19                	je     f0b <twofiles+0x1c1>
          printf(1, "wrong char\n");
     ef2:	c7 44 24 04 ca 47 00 	movl   $0x47ca,0x4(%esp)
     ef9:	00 
     efa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f01:	e8 9f 2e 00 00       	call   3da5 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f24:	00 
     f25:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
     f2c:	00 
    ...
    if(total != 12*500){
     ...
     f5c:	c7 44 24 04 d6 47 00 	movl   $0x47d6,0x4(%esp)
     f63:	00 
     f64:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f6b:	e8 35 2e 00 00       	call   3da5 <printf>
      exit();
  ...
  unlink("f1");
     f83:	c7 04 24 a4 47 00 00 	movl   $0x47a4,(%esp)
     f8a:	e8 dd 2c 00 00       	call   3c6c <unlink>
  unlink("f2");
     f8f:	c7 04 24 a7 47 00 00 	movl   $0x47a7,(%esp)
     f96:	e8 d1 2c 00 00       	call   3c6c <unlink>

  printf(1, "twofiles ok\n");
     f9b:	c7 44 24 04 e7 47 00 	movl   $0x47e7,0x4(%esp)
     fa2:	00 
     fa3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faa:	e8 f6 2d 00 00       	call   3da5 <printf>
}
     faf:	c9                   	leave  
     fb0:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fb7:	c7 44 24 04 f4 47 00 	movl   $0x47f4,0x4(%esp)
     fbe:	00 
     fbf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fc6:	e8 da 2d 00 00       	call   3da5 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fd9:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     fe0:	00 
     fe1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fe8:	e8 b8 2d 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    103a:	79 19                	jns    1055 <createdelete+0xa4>
      printf(1, "create failed\n");
    103c:	c7 44 24 04 aa 47 00 	movl   $0x47aa,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 55 2d 00 00       	call   3da5 <printf>
      exit();
    ...
    1092:	c7 44 24 04 07 48 00 	movl   $0x4807,0x4(%esp)
    1099:	00 
    109a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a1:	e8 ff 2c 00 00       	call   3da5 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1111:	c7 44 24 04 18 48 00 	movl   $0x4818,0x4(%esp)
    1118:	00 
    1119:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1120:	e8 80 2c 00 00       	call   3da5 <printf>
      exit();
    ...
    1143:	c7 44 24 04 3c 48 00 	movl   $0x483c,0x4(%esp)
    114a:	00 
    114b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1152:	e8 4e 2c 00 00       	call   3da5 <printf>
      exit();
    ...
    11a9:	c7 44 24 04 18 48 00 	movl   $0x4818,0x4(%esp)
    11b0:	00 
    11b1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11b8:	e8 e8 2b 00 00       	call   3da5 <printf>
      exit();
    ...
    11db:	c7 44 24 04 3c 48 00 	movl   $0x483c,0x4(%esp)
    11e2:	00 
    11e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ea:	e8 b6 2b 00 00       	call   3da5 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    124d:	c7 44 24 04 5c 48 00 	movl   $0x485c,0x4(%esp)
    1254:	00 
    1255:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    125c:	e8 44 2b 00 00       	call   3da5 <printf>
}
    1261:	c9                   	leave  
    1262:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1269:	c7 44 24 04 6d 48 00 	movl   $0x486d,0x4(%esp)
    1270:	00 
    1271:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1278:	e8 28 2b 00 00       	call   3da5 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    127d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1284:	00 
    1285:	c7 04 24 7e 48 00 00 	movl   $0x487e,(%esp)
  ...
  if(fd < 0){
    ...
    129a:	c7 44 24 04 89 48 00 	movl   $0x4889,0x4(%esp)
    12a1:	00 
    12a2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12a9:	e8 f7 2a 00 00       	call   3da5 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12ba:	00 
    12bb:	c7 44 24 04 a3 48 00 	movl   $0x48a3,0x4(%esp)
    12c2:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e0:	00 
    12e1:	c7 04 24 7e 48 00 00 	movl   $0x487e,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    137c:	00 
    137d:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    1384:	00 
    ...
    1395:	c7 44 24 04 df 48 00 	movl   $0x48df,0x4(%esp)
    139c:	00 
    139d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a4:	e8 fc 29 00 00       	call   3da5 <printf>
    exit();
    13a9:	e8 6e 28 00 00       	call   3c1c <exit>
  }
  if(buf[0] != 'h'){
    13ae:	0f b6 05 a0 81 00 00 	movzbl 0x81a0,%eax
    13b5:	3c 68                	cmp    $0x68,%al
    13b7:	74 19                	je     13d2 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13b9:	c7 44 24 04 f6 48 00 	movl   $0x48f6,0x4(%esp)
    13c0:	00 
    13c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13c8:	e8 d8 29 00 00       	call   3da5 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13d9:	00 
    13da:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    13e1:	00 
    ...
    13f2:	c7 44 24 04 0d 49 00 	movl   $0x490d,0x4(%esp)
    13f9:	00 
    13fa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1401:	e8 9f 29 00 00       	call   3da5 <printf>
    exit();
  ...
  unlink("unlinkread");
    1416:	c7 04 24 7e 48 00 00 	movl   $0x487e,(%esp)
    141d:	e8 4a 28 00 00       	call   3c6c <unlink>
  printf(1, "unlinkread ok\n");
    1422:	c7 44 24 04 26 49 00 	movl   $0x4926,0x4(%esp)
    1429:	00 
    142a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1431:	e8 6f 29 00 00       	call   3da5 <printf>
}
    1436:	c9                   	leave  
    1437:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    143e:	c7 44 24 04 35 49 00 	movl   $0x4935,0x4(%esp)
    1445:	00 
    1446:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    144d:	e8 53 29 00 00       	call   3da5 <printf>

  unlink("lf1");
    1452:	c7 04 24 3f 49 00 00 	movl   $0x493f,(%esp)
    1459:	e8 0e 28 00 00       	call   3c6c <unlink>
  unlink("lf2");
    145e:	c7 04 24 43 49 00 00 	movl   $0x4943,(%esp)
    1465:	e8 02 28 00 00       	call   3c6c <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146a:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1471:	00 
    1472:	c7 04 24 3f 49 00 00 	movl   $0x493f,(%esp)
  ...
  if(fd < 0){
    ...
    1487:	c7 44 24 04 47 49 00 	movl   $0x4947,0x4(%esp)
    148e:	00 
    148f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1496:	e8 0a 29 00 00       	call   3da5 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14a7:	00 
    14a8:	c7 44 24 04 a3 48 00 	movl   $0x48a3,0x4(%esp)
    14af:	00 
    ...
    14c0:	c7 44 24 04 5a 49 00 	movl   $0x495a,0x4(%esp)
    14c7:	00 
    14c8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14cf:	e8 d1 28 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1559:	00 
    155a:	c7 04 24 43 49 00 00 	movl   $0x4943,(%esp)
  ...
  if(fd < 0){
    ...
    156f:	c7 44 24 04 a9 49 00 	movl   $0x49a9,0x4(%esp)
    1576:	00 
    1577:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    157e:	e8 22 28 00 00       	call   3da5 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    158f:	00 
    1590:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    1597:	00 
    ...
    15a8:	c7 44 24 04 ba 49 00 	movl   $0x49ba,0x4(%esp)
    15af:	00 
    15b0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15b7:	e8 e9 27 00 00       	call   3da5 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15cc:	c7 44 24 04 43 49 00 	movl   $0x4943,0x4(%esp)
    15d3:	00 
    15d4:	c7 04 24 43 49 00 00 	movl   $0x4943,(%esp)
    15db:	e8 9c 26 00 00       	call   3c7c <link>
    15e0:	85 c0                	test   %eax,%eax
    15e2:	78 19                	js     15fd <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e4:	c7 44 24 04 cb 49 00 	movl   $0x49cb,0x4(%esp)
    15eb:	00 
    15ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f3:	e8 ad 27 00 00       	call   3da5 <printf>
    exit();
    15f8:	e8 1f 26 00 00       	call   3c1c <exit>
  }

  unlink("lf2");
    15fd:	c7 04 24 43 49 00 00 	movl   $0x4943,(%esp)
    1604:	e8 63 26 00 00       	call   3c6c <unlink>
  if(link("lf2", "lf1") >= 0){
    1609:	c7 44 24 04 3f 49 00 	movl   $0x493f,0x4(%esp)
    1610:	00 
    1611:	c7 04 24 43 49 00 00 	movl   $0x4943,(%esp)
    1618:	e8 5f 26 00 00       	call   3c7c <link>
    161d:	85 c0                	test   %eax,%eax
    161f:	78 19                	js     163a <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1621:	c7 44 24 04 ec 49 00 	movl   $0x49ec,0x4(%esp)
    1628:	00 
    1629:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1630:	e8 70 27 00 00       	call   3da5 <printf>
    exit();
    1635:	e8 e2 25 00 00       	call   3c1c <exit>
  }

  if(link(".", "lf1") >= 0){
    163a:	c7 44 24 04 3f 49 00 	movl   $0x493f,0x4(%esp)
    1641:	00 
    1642:	c7 04 24 0f 4a 00 00 	movl   $0x4a0f,(%esp)
    1649:	e8 2e 26 00 00       	call   3c7c <link>
    164e:	85 c0                	test   %eax,%eax
    1650:	78 19                	js     166b <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1652:	c7 44 24 04 11 4a 00 	movl   $0x4a11,0x4(%esp)
    1659:	00 
    165a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1661:	e8 3f 27 00 00       	call   3da5 <printf>
    exit();
    1666:	e8 b1 25 00 00       	call   3c1c <exit>
  }

  printf(1, "linktest ok\n");
    166b:	c7 44 24 04 2d 4a 00 	movl   $0x4a2d,0x4(%esp)
    1672:	00 
    1673:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167a:	e8 26 27 00 00       	call   3da5 <printf>
}
    167f:	c9                   	leave  
    1680:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1687:	c7 44 24 04 3a 4a 00 	movl   $0x4a3a,0x4(%esp)
    168e:	00 
    168f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1696:	e8 0a 27 00 00       	call   3da5 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16fa:	c7 04 24 4a 4a 00 00 	movl   $0x4a4a,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    173d:	c7 04 24 4a 4a 00 00 	movl   $0x4a4a,(%esp)
    ...
    176e:	c7 44 24 04 4d 4a 00 	movl   $0x4a4d,0x4(%esp)
    1775:	00 
    1776:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    177d:	e8 23 26 00 00       	call   3da5 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d2:	00 
    17d3:	c7 04 24 0f 4a 00 00 	movl   $0x4a0f,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1834:	c7 44 24 04 69 4a 00 	movl   $0x4a69,0x4(%esp)
    183b:	00 
    183c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1843:	e8 5d 25 00 00       	call   3da5 <printf>
        exit();
    ...
    1863:	c7 44 24 04 82 4a 00 	movl   $0x4a82,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1872:	e8 2e 25 00 00       	call   3da5 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18be:	c7 44 24 04 a0 4a 00 	movl   $0x4aa0,0x4(%esp)
    18c5:	00 
    18c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18cd:	e8 d3 24 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18f8:	79 19                	jns    1913 <concreate+0x292>
      printf(1, "fork failed\n");
    18fa:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    1901:	00 
    1902:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1909:	e8 97 24 00 00       	call   3da5 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a1a:	c7 44 24 04 d1 4a 00 	movl   $0x4ad1,0x4(%esp)
    1a21:	00 
    1a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a29:	e8 77 23 00 00       	call   3da5 <printf>
}
    1a2e:	c9                   	leave  
    1a2f:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a36:	c7 44 24 04 df 4a 00 	movl   $0x4adf,0x4(%esp)
    1a3d:	00 
    1a3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a45:	e8 5b 23 00 00       	call   3da5 <printf>

  unlink("x");
    1a4a:	c7 04 24 46 46 00 00 	movl   $0x4646,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a64:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    1a6b:	00 
    1a6c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a73:	e8 2d 23 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad2:	00 
    1ad3:	c7 04 24 46 46 00 00 	movl   $0x4646,(%esp)
    ...
    1b04:	75 16                	jne    1b1c <linkunlink+0xec>
      link("cat", "x");
    1b06:	c7 44 24 04 46 46 00 	movl   $0x4646,0x4(%esp)
    1b0d:	00 
    1b0e:	c7 04 24 f0 4a 00 00 	movl   $0x4af0,(%esp)
    1b15:	e8 62 21 00 00       	call   3c7c <link>
    1b1a:	eb 0c                	jmp    1b28 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b1c:	c7 04 24 46 46 00 00 	movl   $0x4646,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b41:	c7 44 24 04 f4 4a 00 	movl   $0x4af4,0x4(%esp)
    1b48:	00 
    1b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b50:	e8 50 22 00 00       	call   3da5 <printf>
}
    1b55:	c9                   	leave  
    1b56:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b62:	c7 44 24 04 03 4b 00 	movl   $0x4b03,0x4(%esp)
    1b69:	00 
    1b6a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b71:	e8 2f 22 00 00       	call   3da5 <printf>
  unlink("bd");
    1b76:	c7 04 24 10 4b 00 00 	movl   $0x4b10,(%esp)
    1b7d:	e8 ea 20 00 00       	call   3c6c <unlink>

  fd = open("bd", O_CREATE);
    1b82:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b89:	00 
    1b8a:	c7 04 24 10 4b 00 00 	movl   $0x4b10,(%esp)
  ...
  if(fd < 0){
    ...
    1b9f:	c7 44 24 04 13 4b 00 	movl   $0x4b13,0x4(%esp)
    1ba6:	00 
    1ba7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bae:	e8 f2 21 00 00       	call   3da5 <printf>
    exit();
  ...
  unlink("bd");
    1c3d:	c7 04 24 10 4b 00 00 	movl   $0x4b10,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c95:	c7 44 24 04 3d 4b 00 	movl   $0x4b3d,0x4(%esp)
    1c9c:	00 
    1c9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ca4:	e8 fc 20 00 00       	call   3da5 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cbb:	c7 44 24 04 52 4b 00 	movl   $0x4b52,0x4(%esp)
    1cc2:	00 
    1cc3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cca:	e8 d6 20 00 00       	call   3da5 <printf>
}
    1ccf:	c9                   	leave  
    1cd0:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cd7:	c7 44 24 04 5d 4b 00 	movl   $0x4b5d,0x4(%esp)
    1cde:	00 
    1cdf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce6:	e8 ba 20 00 00       	call   3da5 <printf>

  unlink("ff");
    1ceb:	c7 04 24 6a 4b 00 00 	movl   $0x4b6a,(%esp)
    1cf2:	e8 75 1f 00 00       	call   3c6c <unlink>
  if(mkdir("dd") != 0){
    1cf7:	c7 04 24 6d 4b 00 00 	movl   $0x4b6d,(%esp)
    1cfe:	e8 81 1f 00 00       	call   3c84 <mkdir>
    1d03:	85 c0                	test   %eax,%eax
    1d05:	74 19                	je     1d20 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d07:	c7 44 24 04 70 4b 00 	movl   $0x4b70,0x4(%esp)
    1d0e:	00 
    1d0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d16:	e8 8a 20 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d27:	00 
    1d28:	c7 04 24 88 4b 00 00 	movl   $0x4b88,(%esp)
  ...
  if(fd < 0){
    ...
    1d3d:	c7 44 24 04 8e 4b 00 	movl   $0x4b8e,0x4(%esp)
    1d44:	00 
    1d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d4c:	e8 54 20 00 00       	call   3da5 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d5d:	00 
    1d5e:	c7 44 24 04 6a 4b 00 	movl   $0x4b6a,0x4(%esp)
    1d65:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dd5:	00 
    1dd6:	c7 04 24 ec 4b 00 00 	movl   $0x4bec,(%esp)
  ...
  if(fd < 0){
    ...
    1deb:	c7 44 24 04 f5 4b 00 	movl   $0x4bf5,0x4(%esp)
    1df2:	00 
    1df3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dfa:	e8 a6 1f 00 00       	call   3da5 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e0b:	00 
    1e0c:	c7 44 24 04 0d 4c 00 	movl   $0x4c0d,0x4(%esp)
    1e13:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e31:	00 
    1e32:	c7 04 24 10 4c 00 00 	movl   $0x4c10,(%esp)
  ...
  if(fd < 0){
    ...
    1e47:	c7 44 24 04 1c 4c 00 	movl   $0x4c1c,0x4(%esp)
    1e4e:	00 
    1e4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e56:	e8 4a 1f 00 00       	call   3da5 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e67:	00 
    1e68:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    1e6f:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e84:	0f b6 05 a0 81 00 00 	movzbl 0x81a0,%eax
    1e8b:	3c 66                	cmp    $0x66,%al
    1e8d:	74 19                	je     1ea8 <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e8f:	c7 44 24 04 35 4c 00 	movl   $0x4c35,0x4(%esp)
    1e96:	00 
    1e97:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e9e:	e8 02 1f 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fe9:	00 
    1fea:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
  ...
  if(fd < 0){
    ...
    1fff:	c7 44 24 04 1a 4d 00 	movl   $0x4d1a,0x4(%esp)
    2006:	00 
    2007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    200e:	e8 92 1d 00 00       	call   3da5 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    201f:	00 
    2020:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    2027:	00 
    ...
    2038:	c7 44 24 04 32 4d 00 	movl   $0x4d32,0x4(%esp)
    203f:	00 
    2040:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2047:	e8 59 1d 00 00       	call   3da5 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    241d:	c7 44 24 04 ac 4f 00 	movl   $0x4fac,0x4(%esp)
    2424:	00 
    2425:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    242c:	e8 74 19 00 00       	call   3da5 <printf>

  unlink("bigwrite");
    2431:	c7 04 24 bb 4f 00 00 	movl   $0x4fbb,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2450:	00 
    2451:	c7 04 24 bb 4f 00 00 	movl   $0x4fbb,(%esp)
    ...
    2466:	c7 44 24 04 c4 4f 00 	movl   $0x4fc4,0x4(%esp)
    246d:	00 
    246e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2475:	e8 2b 19 00 00       	call   3da5 <printf>
      exit();
    ...
    248f:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    2496:	00 
    ...
    24bb:	c7 44 24 04 dc 4f 00 	movl   $0x4fdc,0x4(%esp)
    24c2:	00 
    24c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24ca:	e8 d6 18 00 00       	call   3da5 <printf>
        exit();
    ...
    unlink("bigwrite");
    24e9:	c7 04 24 bb 4f 00 00 	movl   $0x4fbb,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2509:	c7 44 24 04 ee 4f 00 	movl   $0x4fee,0x4(%esp)
    2510:	00 
    2511:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2518:	e8 88 18 00 00       	call   3da5 <printf>
}
    251d:	c9                   	leave  
    251e:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2525:	c7 44 24 04 fb 4f 00 	movl   $0x4ffb,0x4(%esp)
    252c:	00 
    252d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2534:	e8 6c 18 00 00       	call   3da5 <printf>

  unlink("bigfile");
    2539:	c7 04 24 09 50 00 00 	movl   $0x5009,(%esp)
  ...
  if(fd < 0){
    ...
    2562:	c7 44 24 04 11 50 00 	movl   $0x5011,0x4(%esp)
    2569:	00 
    256a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2571:	e8 2f 18 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2593:	c7 04 24 a0 81 00 00 	movl   $0x81a0,(%esp)
    259a:	e8 d7 14 00 00       	call   3a76 <memset>
    if(write(fd, buf, 600) != 600){
    259f:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25a6:	00 
    25a7:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    25ae:	00 
    ...
    25c1:	c7 44 24 04 27 50 00 	movl   $0x5027,0x4(%esp)
    25c8:	00 
    25c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d0:	e8 d0 17 00 00       	call   3da5 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25f6:	00 
    25f7:	c7 04 24 09 50 00 00 	movl   $0x5009,(%esp)
  ...
  if(fd < 0){
    ...
    260c:	c7 44 24 04 3d 50 00 	movl   $0x503d,0x4(%esp)
    2613:	00 
    2614:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    261b:	e8 85 17 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    263a:	00 
    263b:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    2642:	00 
    ...
    2657:	c7 44 24 04 52 50 00 	movl   $0x5052,0x4(%esp)
    265e:	00 
    265f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2666:	e8 3a 17 00 00       	call   3da5 <printf>
      exit();
    ...
    2683:	c7 44 24 04 67 50 00 	movl   $0x5067,0x4(%esp)
    268a:	00 
    268b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2692:	e8 0e 17 00 00       	call   3da5 <printf>
      exit();
    2697:	e8 80 15 00 00       	call   3c1c <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    269c:	0f b6 05 a0 81 00 00 	movzbl 0x81a0,%eax
    ...
    26b7:	0f b6 05 cb 82 00 00 	movzbl 0x82cb,%eax
    ...
    26d2:	c7 44 24 04 7b 50 00 	movl   $0x507b,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 bf 16 00 00       	call   3da5 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 94 50 00 	movl   $0x5094,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 82 16 00 00       	call   3da5 <printf>
    exit();
    2723:	e8 f4 14 00 00       	call   3c1c <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 09 50 00 00 	movl   $0x5009,(%esp)
    272f:	e8 38 15 00 00       	call   3c6c <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 ae 50 00 	movl   $0x50ae,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 5d 16 00 00       	call   3da5 <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 4c 51 00 00 	movl   $0x514c,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 7c 51 00 	movl   $0x517c,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 be 15 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 bc 51 00 00 	movl   $0x51bc,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 ec 51 00 	movl   $0x51ec,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 7d 15 00 00       	call   3da5 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 95 53 00 	movl   $0x5395,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 73 13 00 00       	call   3da5 <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 a2 53 00 00 	movl   $0x53a2,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 aa 53 00 	movl   $0x53aa,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 42 13 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 db 53 00 00 	movl   $0x53db,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 e6 53 00 	movl   $0x53e6,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 d8 12 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 db 53 00 00 	movl   $0x53db,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 0f 4a 00 00 	movl   $0x4a0f,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 80 54 00 	movl   $0x5480,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 c0 11 00 00       	call   3da5 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 9f 54 00 	movl   $0x549f,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 71 11 00 00       	call   3da5 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 b3 54 00 	movl   $0x54b3,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 4d 11 00 00       	call   3da5 <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 c3 54 00 	movl   $0x54c3,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 31 11 00 00       	call   3da5 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 03 55 00 00 	movl   $0x5503,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 03 55 00 00 	movl   $0x5503,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 26 53 00 00 	movl   $0x5326,(%esp)
    2d63:	e8 24 0f 00 00       	call   3c8c <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 06 55 00 	movl   $0x5506,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 29 10 00 00       	call   3da5 <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 1a 55 00 	movl   $0x551a,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 0d 10 00 00       	call   3da5 <printf>
    ...
    2db5:	e8 62 0e 00 00       	call   3c1c <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 28 55 00 	movl   $0x5528,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 be 0f 00 00       	call   3da5 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 4a 55 00 	movl   $0x554a,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 9c 0f 00 00       	call   3da5 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 5e 55 00 	movl   $0x555e,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 6f 0f 00 00       	call   3da5 <printf>
    exit();
    2e36:	e8 e1 0d 00 00       	call   3c1c <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 71 55 00 	movl   $0x5571,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 56 0f 00 00       	call   3da5 <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 ac 59 00 00       	mov    0x59ac,%eax
    2e60:	c7 44 24 04 7f 55 00 	movl   $0x557f,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 35 0f 00 00       	call   3da5 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 ac 59 00 00       	mov    0x59ac,%eax
    ...
    2ec8:	c7 44 24 04 8a 55 00 	movl   $0x558a,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 cd 0e 00 00       	call   3da5 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 ac 59 00 00       	mov    0x59ac,%eax
    2f0c:	c7 44 24 04 a5 55 00 	movl   $0x55a5,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 89 0e 00 00       	call   3da5 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 ac 59 00 00       	mov    0x59ac,%eax
    2f4f:	c7 44 24 04 bc 55 00 	movl   $0x55bc,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 46 0e 00 00       	call   3da5 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 ac 59 00 00       	mov    0x59ac,%eax
    2faf:	c7 44 24 04 d8 55 00 	movl   $0x55d8,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 e6 0d 00 00       	call   3da5 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 ac 59 00 00       	mov    0x59ac,%eax
    2ffa:	c7 44 24 04 16 56 00 	movl   $0x5616,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 9b 0d 00 00       	call   3da5 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 ac 59 00 00       	mov    0x59ac,%eax
    ...
    303e:	c7 44 24 04 34 56 00 	movl   $0x5634,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 57 0d 00 00       	call   3da5 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 ac 59 00 00       	mov    0x59ac,%eax
    ...
    30a5:	c7 44 24 04 6c 56 00 	movl   $0x566c,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 f0 0c 00 00       	call   3da5 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 ac 59 00 00       	mov    0x59ac,%eax
    30c9:	c7 44 24 04 94 56 00 	movl   $0x5694,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 cc 0c 00 00       	call   3da5 <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 ac 59 00 00       	mov    0x59ac,%eax
    ...
    3128:	c7 44 24 04 c4 56 00 	movl   $0x56c4,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 6d 0c 00 00       	call   3da5 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 ac 59 00 00       	mov    0x59ac,%eax
    3161:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 34 0c 00 00       	call   3da5 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 e1 45 00 	movl   $0x45e1,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 b4 0b 00 00       	call   3da5 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    323f:	00 
    3240:	c7 44 24 04 46 46 00 	movl   $0x4646,0x4(%esp)
    3247:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e1:	a1 ac 59 00 00       	mov    0x59ac,%eax
    32e6:	c7 44 24 04 fe 56 00 	movl   $0x56fe,0x4(%esp)
    32ed:	00 
    32ee:	89 04 24             	mov    %eax,(%esp)
    32f1:	e8 af 0a 00 00       	call   3da5 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    3329:	a1 ac 59 00 00       	mov    0x59ac,%eax
    332e:	c7 44 24 04 19 57 00 	movl   $0x5719,0x4(%esp)
    3335:	00 
    3336:	89 04 24             	mov    %eax,(%esp)
    3339:	e8 67 0a 00 00       	call   3da5 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    336f:	a1 ac 59 00 00       	mov    0x59ac,%eax
    3374:	c7 44 24 04 27 57 00 	movl   $0x5727,0x4(%esp)
    337b:	00 
    337c:	89 04 24             	mov    %eax,(%esp)
    337f:	e8 21 0a 00 00       	call   3da5 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e1:	c7 04 24 36 57 00 00 	movl   $0x5736,(%esp)
    33e8:	e8 8f 08 00 00       	call   3c7c <link>
    33ed:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f0:	74 1a                	je     340c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f2:	a1 ac 59 00 00       	mov    0x59ac,%eax
    33f7:	c7 44 24 04 41 57 00 	movl   $0x5741,0x4(%esp)
    33fe:	00 
    33ff:	89 04 24             	mov    %eax,(%esp)
    3402:	e8 9e 09 00 00       	call   3da5 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    341f:	a1 ac 59 00 00       	mov    0x59ac,%eax
    3424:	c7 44 24 04 5a 57 00 	movl   $0x575a,0x4(%esp)
    342b:	00 
    342c:	89 04 24             	mov    %eax,(%esp)
    342f:	e8 71 09 00 00       	call   3da5 <printf>
}
    3434:	c9                   	leave  
    3435:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343c:	a1 ac 59 00 00       	mov    0x59ac,%eax
    3441:	c7 44 24 04 67 57 00 	movl   $0x5767,0x4(%esp)
    3448:	00 
    3449:	89 04 24             	mov    %eax,(%esp)
    344c:	e8 54 09 00 00       	call   3da5 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    3451:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3458:	eb 2c                	jmp    3486 <bsstest+0x50>
    if(uninit[i] != '\0'){
    345a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    345d:	0f b6 80 80 5a 00 00 	movzbl 0x5a80(%eax),%eax
    3464:	84 c0                	test   %al,%al
    3466:	74 1a                	je     3482 <bsstest+0x4c>
      printf(stdout, "bss test failed\n");
    3468:	a1 ac 59 00 00       	mov    0x59ac,%eax
    346d:	c7 44 24 04 71 57 00 	movl   $0x5771,0x4(%esp)
    3474:	00 
    3475:	89 04 24             	mov    %eax,(%esp)
    3478:	e8 28 09 00 00       	call   3da5 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3490:	a1 ac 59 00 00       	mov    0x59ac,%eax
    3495:	c7 44 24 04 82 57 00 	movl   $0x5782,0x4(%esp)
    349c:	00 
    349d:	89 04 24             	mov    %eax,(%esp)
    34a0:	e8 00 09 00 00       	call   3da5 <printf>
}
    34a5:	c9                   	leave  
    34a6:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ad:	c7 04 24 8f 57 00 00 	movl   $0x578f,(%esp)
  ...
  if(pid == 0){
    ...
    34d7:	c7 04 85 e0 59 00 00 	movl   $0x579c,0x59e0(,%eax,4)
    34de:	9c 57 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34ea:	7e e8                	jle    34d4 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34ec:	c7 05 5c 5a 00 00 00 	movl   $0x0,0x5a5c
    34f3:	00 00 00 
    printf(stdout, "bigarg test\n");
    34f6:	a1 ac 59 00 00       	mov    0x59ac,%eax
    34fb:	c7 44 24 04 79 58 00 	movl   $0x5879,0x4(%esp)
    3502:	00 
    3503:	89 04 24             	mov    %eax,(%esp)
    3506:	e8 9a 08 00 00       	call   3da5 <printf>
    exec("echo", args);
    350b:	c7 44 24 04 e0 59 00 	movl   $0x59e0,0x4(%esp)
    3512:	00 
    3513:	c7 04 24 a0 42 00 00 	movl   $0x42a0,(%esp)
    351a:	e8 35 07 00 00       	call   3c54 <exec>
    printf(stdout, "bigarg test ok\n");
    351f:	a1 ac 59 00 00       	mov    0x59ac,%eax
    3524:	c7 44 24 04 86 58 00 	movl   $0x5886,0x4(%esp)
    352b:	00 
    352c:	89 04 24             	mov    %eax,(%esp)
    352f:	e8 71 08 00 00       	call   3da5 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3534:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    353b:	00 
    353c:	c7 04 24 8f 57 00 00 	movl   $0x578f,(%esp)
    ...
    3561:	a1 ac 59 00 00       	mov    0x59ac,%eax
    3566:	c7 44 24 04 96 58 00 	movl   $0x5896,0x4(%esp)
    356d:	00 
    356e:	89 04 24             	mov    %eax,(%esp)
    3571:	e8 2f 08 00 00       	call   3da5 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3587:	00 
    3588:	c7 04 24 8f 57 00 00 	movl   $0x578f,(%esp)
  ...
  if(fd < 0){
    ...
    359d:	a1 ac 59 00 00       	mov    0x59ac,%eax
    35a2:	c7 44 24 04 af 58 00 	movl   $0x58af,0x4(%esp)
    35a9:	00 
    35aa:	89 04 24             	mov    %eax,(%esp)
    35ad:	e8 f3 07 00 00       	call   3da5 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35c2:	c7 04 24 8f 57 00 00 	movl   $0x578f,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35de:	c7 44 24 04 c4 58 00 	movl   $0x58c4,0x4(%esp)
    35e5:	00 
    35e6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35ed:	e8 b3 07 00 00       	call   3da5 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36ce:	c7 44 24 04 d1 58 00 	movl   $0x58d1,0x4(%esp)
    36d5:	00 
    36d6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36dd:	e8 c3 06 00 00       	call   3da5 <printf>
    ...
    3705:	c7 44 24 04 dd 58 00 	movl   $0x58dd,0x4(%esp)
    370c:	00 
    370d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3714:	e8 8c 06 00 00       	call   3da5 <printf>
      break;
    ...
    3729:	00 
    372a:	c7 44 24 04 a0 81 00 	movl   $0x81a0,0x4(%esp)
    3731:	00 
    ...
    375d:	c7 44 24 04 ed 58 00 	movl   $0x58ed,0x4(%esp)
    3764:	00 
    3765:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    376c:	e8 34 06 00 00       	call   3da5 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3879:	c7 44 24 04 fd 58 00 	movl   $0x58fd,0x4(%esp)
    3880:	00 
    3881:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3888:	e8 18 05 00 00       	call   3da5 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3896:	a1 b0 59 00 00       	mov    0x59b0,%eax
    389b:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38a1:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38a6:	a3 b0 59 00 00       	mov    %eax,0x59b0
  return randstate;
    38ab:	a1 b0 59 00 00       	mov    0x59b0,%eax
}
    38b0:	5d                   	pop    %ebp
    38b1:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3907:	00 
    3908:	c7 04 24 27 59 00 00 	movl   $0x5927,(%esp)
...
putc(int fd, char c)
{
    ...
    3ccf:	83 ec 28             	sub    $0x28,%esp
    3cd2:	8b 45 0c             	mov    0xc(%ebp),%eax
    3cd5:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3cd8:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3cdf:	00 
    3ce0:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3ce3:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ce7:	8b 45 08             	mov    0x8(%ebp),%eax
    3cea:	89 04 24             	mov    %eax,(%esp)
    3ced:	e8 4a ff ff ff       	call   3c3c <write>
}
    3cf2:	c9                   	leave  
    3cf3:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3cfb:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d02:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d06:	74 17                	je     3d1f <printint+0x2b>
    3d08:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d0c:	79 11                	jns    3d1f <printint+0x2b>
    neg = 1;
    3d0e:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3d1d:	eb 06                	jmp    3d25 <printint+0x31>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  i = 0;
    3d25:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d2c:	8b 4d ec             	mov    -0x14(%ebp),%ecx
    3d2f:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3d32:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d35:	ba 00 00 00 00       	mov    $0x0,%edx
    3d3a:	f7 f3                	div    %ebx
    3d3c:	89 d0                	mov    %edx,%eax
    3d3e:	0f b6 80 b4 59 00 00 	movzbl 0x59b4(%eax),%eax
    3d45:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
    3d49:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  }while((x /= base) != 0);
    3d4d:	8b 45 10             	mov    0x10(%ebp),%eax
    3d50:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    3d53:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d56:	ba 00 00 00 00       	mov    $0x0,%edx
    3d5b:	f7 75 d4             	divl   -0x2c(%ebp)
    3d5e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3d61:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3d65:	75 c5                	jne    3d2c <printint+0x38>
  if(neg)
    3d67:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d6b:	74 28                	je     3d95 <printint+0xa1>
    buf[i++] = '-';
    3d6d:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d70:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
    3d75:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)

  while(--i >= 0)
    3d79:	eb 1a                	jmp    3d95 <printint+0xa1>
    putc(fd, buf[i]);
    3d7b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d7e:	0f b6 44 05 dc       	movzbl -0x24(%ebp,%eax,1),%eax
    3d83:	0f be c0             	movsbl %al,%eax
    3d86:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d8a:	8b 45 08             	mov    0x8(%ebp),%eax
    3d8d:	89 04 24             	mov    %eax,(%esp)
    3d90:	e8 37 ff ff ff       	call   3ccc <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3d95:	83 6d ec 01          	subl   $0x1,-0x14(%ebp)
    3d99:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d9d:	79 dc                	jns    3d7b <printint+0x87>
    putc(fd, buf[i]);
}
    3d9f:	83 c4 44             	add    $0x44,%esp
    3da2:	5b                   	pop    %ebx
    3da3:	5d                   	pop    %ebp
    3da4:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3da8:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3dab:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3db2:	8d 45 0c             	lea    0xc(%ebp),%eax
    3db5:	83 c0 04             	add    $0x4,%eax
    3db8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(i = 0; fmt[i]; i++){
    3dbb:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    3dc2:	e9 7e 01 00 00       	jmp    3f45 <printf+0x1a0>
    c = fmt[i] & 0xff;
    3dc7:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dca:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3dcd:	8d 04 02             	lea    (%edx,%eax,1),%eax
    3dd0:	0f b6 00             	movzbl (%eax),%eax
    3dd3:	0f be c0             	movsbl %al,%eax
    3dd6:	25 ff 00 00 00       	and    $0xff,%eax
    3ddb:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(state == 0){
    3dde:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3de2:	75 2c                	jne    3e10 <printf+0x6b>
      if(c == '%'){
    3de4:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    3de8:	75 0c                	jne    3df6 <printf+0x51>
        state = '%';
    3dea:	c7 45 f0 25 00 00 00 	movl   $0x25,-0x10(%ebp)
    3df1:	e9 4b 01 00 00       	jmp    3f41 <printf+0x19c>
      } else {
        putc(fd, c);
    3df6:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3df9:	0f be c0             	movsbl %al,%eax
    3dfc:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e00:	8b 45 08             	mov    0x8(%ebp),%eax
    3e03:	89 04 24             	mov    %eax,(%esp)
    3e06:	e8 c1 fe ff ff       	call   3ccc <putc>
    3e0b:	e9 31 01 00 00       	jmp    3f41 <printf+0x19c>
      }
    } else if(state == '%'){
    3e10:	83 7d f0 25          	cmpl   $0x25,-0x10(%ebp)
    3e14:	0f 85 27 01 00 00    	jne    3f41 <printf+0x19c>
      if(c == 'd'){
    3e1a:	83 7d e8 64          	cmpl   $0x64,-0x18(%ebp)
    3e1e:	75 2d                	jne    3e4d <printf+0xa8>
        printint(fd, *ap, 10, 1);
    3e20:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3e23:	8b 00                	mov    (%eax),%eax
    3e25:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e2c:	00 
    3e2d:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e34:	00 
    3e35:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e39:	8b 45 08             	mov    0x8(%ebp),%eax
    3e3c:	89 04 24             	mov    %eax,(%esp)
    3e3f:	e8 b0 fe ff ff       	call   3cf4 <printint>
        ap++;
    3e44:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3e48:	e9 ed 00 00 00       	jmp    3f3a <printf+0x195>
      } else if(c == 'x' || c == 'p'){
    3e4d:	83 7d e8 78          	cmpl   $0x78,-0x18(%ebp)
    3e51:	74 06                	je     3e59 <printf+0xb4>
    3e53:	83 7d e8 70          	cmpl   $0x70,-0x18(%ebp)
    3e57:	75 2d                	jne    3e86 <printf+0xe1>
        printint(fd, *ap, 16, 0);
    3e59:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3e5c:	8b 00                	mov    (%eax),%eax
    3e5e:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e65:	00 
    3e66:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e6d:	00 
    3e6e:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e72:	8b 45 08             	mov    0x8(%ebp),%eax
    3e75:	89 04 24             	mov    %eax,(%esp)
    3e78:	e8 77 fe ff ff       	call   3cf4 <printint>
        ap++;
    3e7d:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
      }
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
    ...
    3e81:	e9 b4 00 00 00       	jmp    3f3a <printf+0x195>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3e86:	83 7d e8 73          	cmpl   $0x73,-0x18(%ebp)
    3e8a:	75 46                	jne    3ed2 <printf+0x12d>
        s = (char*)*ap;
    3e8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3e8f:	8b 00                	mov    (%eax),%eax
    3e91:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        ap++;
    3e94:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
        if(s == 0)
    3e98:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    3e9c:	75 27                	jne    3ec5 <printf+0x120>
          s = "(null)";
    3e9e:	c7 45 e4 62 59 00 00 	movl   $0x5962,-0x1c(%ebp)
        while(*s != 0){
    3ea5:	eb 1f                	jmp    3ec6 <printf+0x121>
          putc(fd, *s);
    3ea7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3eaa:	0f b6 00             	movzbl (%eax),%eax
    3ead:	0f be c0             	movsbl %al,%eax
    3eb0:	89 44 24 04          	mov    %eax,0x4(%esp)
    3eb4:	8b 45 08             	mov    0x8(%ebp),%eax
    3eb7:	89 04 24             	mov    %eax,(%esp)
    3eba:	e8 0d fe ff ff       	call   3ccc <putc>
          s++;
    3ebf:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    3ec3:	eb 01                	jmp    3ec6 <printf+0x121>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3ecc:	84 c0                	test   %al,%al
    3ece:	75 d7                	jne    3ea7 <printf+0x102>
    3ed0:	eb 68                	jmp    3f3a <printf+0x195>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3ed2:	83 7d e8 63          	cmpl   $0x63,-0x18(%ebp)
    3ed6:	75 1d                	jne    3ef5 <printf+0x150>
        putc(fd, *ap);
    3ed8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3edb:	8b 00                	mov    (%eax),%eax
    3edd:	0f be c0             	movsbl %al,%eax
    3ee0:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ee4:	8b 45 08             	mov    0x8(%ebp),%eax
    3ee7:	89 04 24             	mov    %eax,(%esp)
    3eea:	e8 dd fd ff ff       	call   3ccc <putc>
        ap++;
    3eef:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3ef3:	eb 45                	jmp    3f3a <printf+0x195>
      } else if(c == '%'){
    3ef5:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    3ef9:	75 17                	jne    3f12 <printf+0x16d>
        putc(fd, c);
    ...
    3f0b:	e8 bc fd ff ff       	call   3ccc <putc>
    3f10:	eb 28                	jmp    3f3a <printf+0x195>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f12:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f19:	00 
    3f1a:	8b 45 08             	mov    0x8(%ebp),%eax
    3f1d:	89 04 24             	mov    %eax,(%esp)
    3f20:	e8 a7 fd ff ff       	call   3ccc <putc>
        putc(fd, c);
    3f25:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f28:	0f be c0             	movsbl %al,%eax
    3f2b:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f2f:	8b 45 08             	mov    0x8(%ebp),%eax
    3f32:	89 04 24             	mov    %eax,(%esp)
    3f35:	e8 92 fd ff ff       	call   3ccc <putc>
      }
      state = 0;
    3f3a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f41:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    3f45:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f48:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3f4b:	8d 04 02             	lea    (%edx,%eax,1),%eax
    3f4e:	0f b6 00             	movzbl (%eax),%eax
    3f51:	84 c0                	test   %al,%al
    3f53:	0f 85 6e fe ff ff    	jne    3dc7 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f6b:	a1 68 5a 00 00       	mov    0x5a68,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    402c:	a3 68 5a 00 00       	mov    %eax,0x5a68
}
    4031:	c9                   	leave  
    4032:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40a0:	a1 68 5a 00 00       	mov    0x5a68,%eax
    40a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40ac:	75 23                	jne    40d1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40ae:	c7 45 f0 60 5a 00 00 	movl   $0x5a60,-0x10(%ebp)
    40b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40b8:	a3 68 5a 00 00       	mov    %eax,0x5a68
    40bd:	a1 68 5a 00 00       	mov    0x5a68,%eax
    40c2:	a3 60 5a 00 00       	mov    %eax,0x5a60
    base.s.size = 0;
    40c7:	c7 05 64 5a 00 00 00 	movl   $0x0,0x5a64
    40ce:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    40d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d4:	8b 00                	mov    (%eax),%eax
    40d6:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(p->s.size >= nunits){
    40d9:	8b 45 ec             	mov    -0x14(%ebp),%eax
    40dc:	8b 40 04             	mov    0x4(%eax),%eax
    40df:	3b 45 f4             	cmp    -0xc(%ebp),%eax
    40e2:	72 4d                	jb     4131 <malloc+0xa6>
      if(p->s.size == nunits)
    40e4:	8b 45 ec             	mov    -0x14(%ebp),%eax
    40e7:	8b 40 04             	mov    0x4(%eax),%eax
    40ea:	3b 45 f4             	cmp    -0xc(%ebp),%eax
    40ed:	75 0c                	jne    40fb <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    40ef:	8b 45 ec             	mov    -0x14(%ebp),%eax
    ...
    if(p == freep)
    4131:	a1 68 5a 00 00       	mov    0x5a68,%eax
    4136:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    ...
    4146:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4149:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
...
xchg(volatile uint *addr, uint newval)
{
  ...
  asm volatile("lock; xchgl %0, %1" :
    4172:	8b 55 08             	mov    0x8(%ebp),%edx
    4175:	8b 45 0c             	mov    0xc(%ebp),%eax
    4178:	8b 4d 08             	mov    0x8(%ebp),%ecx
    417b:	f0 87 02             	lock xchg %eax,(%edx)
    417e:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
void lock_init(lock_t *lock){
    4186:	55                   	push   %ebp
    4187:	89 e5                	mov    %esp,%ebp
    lock->locked = 0;
    4189:	8b 45 08             	mov    0x8(%ebp),%eax
    418c:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    4192:	5d                   	pop    %ebp
    4193:	c3                   	ret    

00004194 <lock_acquire>:
void lock_acquire(lock_t *lock){
    ...
    419d:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    41a4:	00 
    41a5:	89 04 24             	mov    %eax,(%esp)
    41a8:	e8 bf ff ff ff       	call   416c <xchg>
    41ad:	85 c0                	test   %eax,%eax
    41af:	75 e9                	jne    419a <lock_acquire+0x6>
}
    41b1:	c9                   	leave  
    41b2:	c3                   	ret    

000041b3 <lock_release>:
void lock_release(lock_t *lock){
    41b3:	55                   	push   %ebp
    41b4:	89 e5                	mov    %esp,%ebp
    41b6:	83 ec 08             	sub    $0x8,%esp
    xchg(&lock->locked,0);
    41b9:	8b 45 08             	mov    0x8(%ebp),%eax
    41bc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    41c3:	00 
    41c4:	89 04 24             	mov    %eax,(%esp)
    41c7:	e8 a0 ff ff ff       	call   416c <xchg>
}
    41cc:	c9                   	leave  
    41cd:	c3                   	ret    

000041ce <thread_create>:


void *thread_create(void(*start_routine)(void*), void *arg){
    41ce:	55                   	push   %ebp
    41cf:	89 e5                	mov    %esp,%ebp
    41d1:	83 ec 28             	sub    $0x28,%esp
    int tid;
    void * stack = malloc(2 * 4096);
    41d4:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    41db:	e8 ab fe ff ff       	call   408b <malloc>
    41e0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    void *garbage_stack = stack; 
    41e3:	8b 45 f0             	mov    -0x10(%ebp),%eax
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    41ec:	25 ff 0f 00 00       	and    $0xfff,%eax
    41f1:	85 c0                	test   %eax,%eax
    41f3:	74 15                	je     420a <thread_create+0x3c>
        stack = stack + (4096 - (uint)stack % 4096);
    41f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41f8:	89 c2                	mov    %eax,%edx
    41fa:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    4200:	b8 00 10 00 00       	mov    $0x1000,%eax
    4205:	29 d0                	sub    %edx,%eax
    4207:	01 45 f0             	add    %eax,-0x10(%ebp)
    }
    if (stack == 0){
    420a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    420e:	75 1b                	jne    422b <thread_create+0x5d>

        printf(1,"malloc fail \n");
    4210:	c7 44 24 04 69 59 00 	movl   $0x5969,0x4(%esp)
    4217:	00 
    4218:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    421f:	e8 81 fb ff ff       	call   3da5 <printf>
        return 0;
    4224:	b8 00 00 00 00       	mov    $0x0,%eax
    4229:	eb 70                	jmp    429b <thread_create+0xcd>
    }

    tid = clone((uint)stack,PSIZE,(uint)start_routine,0);
    422b:	8b 55 08             	mov    0x8(%ebp),%edx
    422e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4231:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4238:	00 
    4239:	89 54 24 08          	mov    %edx,0x8(%esp)
    423d:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
    4244:	00 
    4245:	89 04 24             	mov    %eax,(%esp)
    4248:	e8 6f fa ff ff       	call   3cbc <clone>
    424d:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(tid < 0){
    4250:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4254:	79 1b                	jns    4271 <thread_create+0xa3>
        printf(1,"clone fails\n");
    4256:	c7 44 24 04 77 59 00 	movl   $0x5977,0x4(%esp)
    425d:	00 
    425e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4265:	e8 3b fb ff ff       	call   3da5 <printf>
        return 0;
    426a:	b8 00 00 00 00       	mov    $0x0,%eax
    426f:	eb 2a                	jmp    429b <thread_create+0xcd>
    }
    if(tid > 0){
    4271:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4275:	7e 05                	jle    427c <thread_create+0xae>
        return garbage_stack;
    4277:	8b 45 f4             	mov    -0xc(%ebp),%eax
    427a:	eb 1f                	jmp    429b <thread_create+0xcd>
    }
    if(tid == 0){
    427c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4280:	75 14                	jne    4296 <thread_create+0xc8>
        printf(1,"tid = 0 return \n");
    4282:	c7 44 24 04 84 59 00 	movl   $0x5984,0x4(%esp)
    4289:	00 
    428a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4291:	e8 0f fb ff ff       	call   3da5 <printf>
    }
//    wait();
//    free(garbage_stack);

    return 0;
    4296:	b8 00 00 00 00       	mov    $0x0,%eax
}
    429b:	c9                   	leave  
    429c:	c3                   	ret    
