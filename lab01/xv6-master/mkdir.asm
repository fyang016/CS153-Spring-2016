...
main(int argc, char *argv[])
{
  ...
  48:	e8 1b 03 00 00       	call   368 <mkdir>
  ...
  61:	c7 44 24 04 66 08 00 	movl   $0x866,0x4(%esp)
  68:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	0f b6 80 8c 08 00 00 	movzbl 0x88c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 580:	75 27                	jne    5a9 <printf+0x120>
          s = "(null)";
 582:	c7 45 e4 82 08 00 00 	movl   $0x882,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64f:	a1 a8 08 00 00       	mov    0x8a8,%eax
...
free(void *ap)
{
 ...
 710:	a3 a8 08 00 00       	mov    %eax,0x8a8
}
 715:	c9                   	leave  
 716:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 781:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 784:	a1 a8 08 00 00       	mov    0x8a8,%eax
 789:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 790:	75 23                	jne    7b5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 792:	c7 45 f0 a0 08 00 00 	movl   $0x8a0,-0x10(%ebp)
 799:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79c:	a3 a8 08 00 00       	mov    %eax,0x8a8
 7a1:	a1 a8 08 00 00       	mov    0x8a8,%eax
 7a6:	a3 a0 08 00 00       	mov    %eax,0x8a0
    base.s.size = 0;
 7ab:	c7 05 a4 08 00 00 00 	movl   $0x0,0x8a4
 7b2:	00 00 00 
  }
 ...
 808:	a3 a8 08 00 00       	mov    %eax,0x8a8
      return (void*)(p + 1);
 ...
 813:	eb 38                	jmp    84d <malloc+0xde>
    ...
    if(p == freep)
 815:	a1 a8 08 00 00       	mov    0x8a8,%eax
