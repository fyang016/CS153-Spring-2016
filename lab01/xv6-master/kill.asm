...
main(int argc, char **argv)
{
  ...
  48:	e8 f5 01 00 00       	call   242 <atoi>
  4d:	89 04 24             	mov    %eax,(%esp)
  50:	e8 b7 02 00 00       	call   30c <kill>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fe:	0f b6 80 48 08 00 00 	movzbl 0x848(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 55c:	75 27                	jne    585 <printf+0x120>
          s = "(null)";
 55e:	c7 45 e4 3f 08 00 00 	movl   $0x83f,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62b:	a1 64 08 00 00       	mov    0x864,%eax
...
free(void *ap)
{
 ...
 6ec:	a3 64 08 00 00       	mov    %eax,0x864
}
 6f1:	c9                   	leave  
 6f2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73f:	e8 d8 fe ff ff       	call   61c <free>
  return freep;
 744:	a1 64 08 00 00       	mov    0x864,%eax
}
 749:	c9                   	leave  
 74a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 75d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 760:	a1 64 08 00 00       	mov    0x864,%eax
 765:	89 45 f0             	mov    %eax,-0x10(%ebp)
 768:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 76c:	75 23                	jne    791 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76e:	c7 45 f0 5c 08 00 00 	movl   $0x85c,-0x10(%ebp)
 775:	8b 45 f0             	mov    -0x10(%ebp),%eax
 778:	a3 64 08 00 00       	mov    %eax,0x864
 77d:	a1 64 08 00 00       	mov    0x864,%eax
 782:	a3 5c 08 00 00       	mov    %eax,0x85c
    base.s.size = 0;
 787:	c7 05 60 08 00 00 00 	movl   $0x0,0x860
 78e:	00 00 00 
  }
 ...
 7e4:	a3 64 08 00 00       	mov    %eax,0x864
      return (void*)(p + 1);
 ...
 7ef:	eb 38                	jmp    829 <malloc+0xde>
    ...
    if(p == freep)
 7f1:	a1 64 08 00 00       	mov    0x864,%eax
