...
cat(int fd)
{
  ...
  5c:	e8 c0 04 00 00       	call   521 <printf>
    exit(1);
...
main(int argc, char *argv[])
{
  ...
  b7:	e8 1c 03 00 00       	call   3d8 <open>
  ...
  d7:	c7 44 24 04 f8 08 00 	movl   $0x8f8,0x4(%esp)
  de:	00 
  df:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e6:	e8 36 04 00 00       	call   521 <printf>
      exit(1);
 ...
 10a:	e8 b1 02 00 00       	call   3c0 <close>
  if(argc <= 1){
    cat(0);
    exit(0);
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ba:	0f b6 80 14 09 00 00 	movzbl 0x914(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 618:	75 27                	jne    641 <printf+0x120>
          s = "(null)";
 61a:	c7 45 e4 0d 09 00 00 	movl   $0x90d,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e7:	a1 48 09 00 00       	mov    0x948,%eax
...
free(void *ap)
{
 ...
 7a8:	a3 48 09 00 00       	mov    %eax,0x948
}
 7ad:	c9                   	leave  
 7ae:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 819:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 81c:	a1 48 09 00 00       	mov    0x948,%eax
 821:	89 45 f0             	mov    %eax,-0x10(%ebp)
 824:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 828:	75 23                	jne    84d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 82a:	c7 45 f0 40 09 00 00 	movl   $0x940,-0x10(%ebp)
 831:	8b 45 f0             	mov    -0x10(%ebp),%eax
 834:	a3 48 09 00 00       	mov    %eax,0x948
 839:	a1 48 09 00 00       	mov    0x948,%eax
 83e:	a3 40 09 00 00       	mov    %eax,0x940
    base.s.size = 0;
 843:	c7 05 44 09 00 00 00 	movl   $0x0,0x944
 84a:	00 00 00 
  }
 ...
 8a0:	a3 48 09 00 00       	mov    %eax,0x948
      return (void*)(p + 1);
 ...
 8ab:	eb 38                	jmp    8e5 <malloc+0xde>
    ...
    if(p == freep)
 8ad:	a1 48 09 00 00       	mov    0x948,%eax
