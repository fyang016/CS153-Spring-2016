...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
   ...
   f:	c7 44 24 04 9e 0b 00 	movl   $0xb9e,0x4(%esp)
  16:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	0f b6 80 ac 0f 00 00 	movzbl 0xfac(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 56d:	75 09                	jne    578 <printf+0x101>
          s = "(null)";
 56f:	c7 45 f4 b2 0b 00 00 	movl   $0xbb2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 639:	a1 c8 0f 00 00       	mov    0xfc8,%eax
...
free(void *ap)
{
 ...
 704:	a3 c8 0f 00 00       	mov    %eax,0xfc8
}
 709:	c9                   	leave  
 70a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 757:	e8 ce fe ff ff       	call   62a <free>
  return freep;
 75c:	a1 c8 0f 00 00       	mov    0xfc8,%eax
}
 761:	c9                   	leave  
 762:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 775:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 778:	a1 c8 0f 00 00       	mov    0xfc8,%eax
 77d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 780:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 784:	75 23                	jne    7a9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 786:	c7 45 f0 c0 0f 00 00 	movl   $0xfc0,-0x10(%ebp)
 78d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 790:	a3 c8 0f 00 00       	mov    %eax,0xfc8
 795:	a1 c8 0f 00 00       	mov    0xfc8,%eax
 79a:	a3 c0 0f 00 00       	mov    %eax,0xfc0
    base.s.size = 0;
 79f:	c7 05 c4 0f 00 00 00 	movl   $0x0,0xfc4
 7a6:	00 00 00 
  }
 ...
 7fc:	a3 c8 0f 00 00       	mov    %eax,0xfc8
      return (void*)(p + 1);
 ...
 807:	eb 38                	jmp    841 <malloc+0xde>
    ...
    if(p == freep)
 809:	a1 c8 0f 00 00       	mov    0xfc8,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8e7:	c7 44 24 04 b9 0b 00 	movl   $0xbb9,0x4(%esp)
 8ee:	00 
 ...
 92c:	c7 44 24 04 c7 0b 00 	movl   $0xbc7,0x4(%esp)
 933:	00 
