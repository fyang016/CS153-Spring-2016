...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 0e 0c 00 	movl   $0xc0e,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 438:	0f b6 80 34 10 00 00 	movzbl 0x1034(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 09                	jne    5a0 <printf+0x101>
          s = "(null)";
 597:	c7 45 f4 27 0c 00 00 	movl   $0xc27,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 50 10 00 00       	mov    0x1050,%eax
...
free(void *ap)
{
 ...
 72c:	a3 50 10 00 00       	mov    %eax,0x1050
}
 731:	c9                   	leave  
 732:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 77f:	e8 ce fe ff ff       	call   652 <free>
  return freep;
 784:	a1 50 10 00 00       	mov    0x1050,%eax
}
 789:	c9                   	leave  
 78a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a0:	a1 50 10 00 00       	mov    0x1050,%eax
 7a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ac:	75 23                	jne    7d1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7ae:	c7 45 f0 48 10 00 00 	movl   $0x1048,-0x10(%ebp)
 7b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b8:	a3 50 10 00 00       	mov    %eax,0x1050
 7bd:	a1 50 10 00 00       	mov    0x1050,%eax
 7c2:	a3 48 10 00 00       	mov    %eax,0x1048
    base.s.size = 0;
 7c7:	c7 05 4c 10 00 00 00 	movl   $0x0,0x104c
 7ce:	00 00 00 
  }
 ...
 824:	a3 50 10 00 00       	mov    %eax,0x1050
      return (void*)(p + 1);
 ...
 82f:	eb 38                	jmp    869 <malloc+0xde>
    ...
    if(p == freep)
 831:	a1 50 10 00 00       	mov    0x1050,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 90f:	c7 44 24 04 2e 0c 00 	movl   $0xc2e,0x4(%esp)
 916:	00 
 ...
 954:	c7 44 24 04 3c 0c 00 	movl   $0xc3c,0x4(%esp)
 95b:	00 
 ...
 980:	c7 44 24 04 49 0c 00 	movl   $0xc49,0x4(%esp)
 987:	00 
...
sem_aquire(struct semaphore * s){
 ...
 aef:	75 43                	jne    b34 <sem_aquire+0x5e>
  		printf(1, "Sem F\n");
 af1:	c7 44 24 04 5a 0c 00 	movl   $0xc5a,0x4(%esp)
 af8:	00 
 ...
 b32:	eb 2e                	jmp    b62 <sem_aquire+0x8c>
  		...
  		printf(1, "Sem A\n");
 b34:	c7 44 24 04 61 0c 00 	movl   $0xc61,0x4(%esp)
 b3b:	00 
...
sem_signal(struct semaphore * s){
 ...
 b67:	83 ec 28             	sub    $0x28,%esp
	printf(1, "Sem R\n");
 b6a:	c7 44 24 04 68 0c 00 	movl   $0xc68,0x4(%esp)
 b71:	00 
 ...
 bbd:	74 2e                	je     bed <sem_signal+0x89>
		printf(1, "Sem A\n");
 bbf:	c7 44 24 04 61 0c 00 	movl   $0xc61,0x4(%esp)
 bc6:	00 
