...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 f6 0b 00 	movl   $0xbf6,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	0f b6 80 58 0c 00 00 	movzbl 0xc58(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 580:	75 27                	jne    5a9 <printf+0x120>
          s = "(null)";
 582:	c7 45 e4 0f 0c 00 00 	movl   $0xc0f,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64f:	a1 74 0c 00 00       	mov    0xc74,%eax
...
free(void *ap)
{
 ...
 710:	a3 74 0c 00 00       	mov    %eax,0xc74
}
 715:	c9                   	leave  
 716:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 763:	e8 d8 fe ff ff       	call   640 <free>
  return freep;
 768:	a1 74 0c 00 00       	mov    0xc74,%eax
}
 76d:	c9                   	leave  
 76e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 781:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 784:	a1 74 0c 00 00       	mov    0xc74,%eax
 789:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 790:	75 23                	jne    7b5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 792:	c7 45 f0 6c 0c 00 00 	movl   $0xc6c,-0x10(%ebp)
 799:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79c:	a3 74 0c 00 00       	mov    %eax,0xc74
 7a1:	a1 74 0c 00 00       	mov    0xc74,%eax
 7a6:	a3 6c 0c 00 00       	mov    %eax,0xc6c
    base.s.size = 0;
 7ab:	c7 05 70 0c 00 00 00 	movl   $0x0,0xc70
 7b2:	00 00 00 
  }
 ...
 808:	a3 74 0c 00 00       	mov    %eax,0xc74
      return (void*)(p + 1);
 ...
 813:	eb 38                	jmp    84d <malloc+0xde>
    ...
    if(p == freep)
 815:	a1 74 0c 00 00       	mov    0xc74,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8f4:	c7 44 24 04 16 0c 00 	movl   $0xc16,0x4(%esp)
 8fb:	00 
 ...
 939:	c7 44 24 04 24 0c 00 	movl   $0xc24,0x4(%esp)
 940:	00 
 ...
 965:	c7 44 24 04 31 0c 00 	movl   $0xc31,0x4(%esp)
 96c:	00 
...
sem_aquire(struct semaphore * s){
 ...
 ad7:	75 43                	jne    b1c <sem_aquire+0x5e>
  		printf(1, "Sem F\n");
 ad9:	c7 44 24 04 42 0c 00 	movl   $0xc42,0x4(%esp)
 ae0:	00 
 ...
 b1a:	eb 2e                	jmp    b4a <sem_aquire+0x8c>
  		...
  		printf(1, "Sem A\n");
 b1c:	c7 44 24 04 49 0c 00 	movl   $0xc49,0x4(%esp)
 b23:	00 
...
sem_signal(struct semaphore * s){
 ...
 b4f:	83 ec 28             	sub    $0x28,%esp
	printf(1, "Sem R\n");
 b52:	c7 44 24 04 50 0c 00 	movl   $0xc50,0x4(%esp)
 b59:	00 
 ...
 ba5:	74 2e                	je     bd5 <sem_signal+0x89>
		printf(1, "Sem A\n");
 ba7:	c7 44 24 04 49 0c 00 	movl   $0xc49,0x4(%esp)
 bae:	00 
