...
int main(int argc, char *argv[]){
  ...
  3c:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
  43:	00 
  ...
  72:	75 19                	jne    8d <main+0x8d>
            printf(1,"thread_create fails\n");
  74:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
  7b:	00 
  ...
  aa:	75 19                	jne    c5 <main+0xc5>
            printf(1,"thread_create fails\n");
  ac:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
  b3:	00 
  ...
  e2:	75 19                	jne    fd <main+0xfd>
            printf(1,"thread_create fails\n");
  e4:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
  eb:	00 
 ...
 11a:	75 19                	jne    135 <main+0x135>
            printf(1,"thread_create fails\n");
 11c:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
 123:	00 
 ...
 13f:	a1 20 12 00 00       	mov    0x1220,%eax
 144:	89 44 24 08          	mov    %eax,0x8(%esp)
 148:	c7 44 24 04 dc 0d 00 	movl   $0xddc,0x4(%esp)
 14f:	00 
 ...
 189:	75 19                	jne    1a4 <main+0x1a4>
            printf(1,"thread_create fails\n");
 18b:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
 192:	00 
 ...
 1c1:	75 19                	jne    1dc <main+0x1dc>
            printf(1,"thread_create fails\n");
 1c3:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
 1ca:	00 
 ...
 1f9:	75 19                	jne    214 <main+0x214>
            printf(1,"thread_create fails\n");
 1fb:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
 202:	00 
 ...
 231:	75 19                	jne    24c <main+0x24c>
            printf(1,"thread_create fails\n");
 233:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
 23a:	00 
 ...
 256:	a1 20 12 00 00       	mov    0x1220,%eax
 25b:	89 44 24 08          	mov    %eax,0x8(%esp)
 25f:	c7 44 24 04 f4 0d 00 	movl   $0xdf4,0x4(%esp)
 266:	00 
...
//    printf(1,"\n n = %d\n",n);
    n++;
 27e:	a1 20 12 00 00       	mov    0x1220,%eax
 283:	83 c0 01             	add    $0x1,%eax
 286:	a3 20 12 00 00       	mov    %eax,0x1220
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 639:	0f b6 80 24 12 00 00 	movzbl 0x1224(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 796:	75 09                	jne    7a1 <printf+0x101>
          s = "(null)";
 798:	c7 45 f4 0d 0e 00 00 	movl   $0xe0d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 862:	a1 40 12 00 00       	mov    0x1240,%eax
...
free(void *ap)
{
 ...
 92d:	a3 40 12 00 00       	mov    %eax,0x1240
}
 932:	c9                   	leave  
 933:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 980:	e8 ce fe ff ff       	call   853 <free>
  return freep;
 985:	a1 40 12 00 00       	mov    0x1240,%eax
}
 98a:	c9                   	leave  
 98b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 99e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 9a1:	a1 40 12 00 00       	mov    0x1240,%eax
 9a6:	89 45 f0             	mov    %eax,-0x10(%ebp)
 9a9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 9ad:	75 23                	jne    9d2 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 9af:	c7 45 f0 38 12 00 00 	movl   $0x1238,-0x10(%ebp)
 9b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 9b9:	a3 40 12 00 00       	mov    %eax,0x1240
 9be:	a1 40 12 00 00       	mov    0x1240,%eax
 9c3:	a3 38 12 00 00       	mov    %eax,0x1238
    base.s.size = 0;
 9c8:	c7 05 3c 12 00 00 00 	movl   $0x0,0x123c
 9cf:	00 00 00 
  }
 ...
 a25:	a3 40 12 00 00       	mov    %eax,0x1240
      return (void*)(p + 1);
 ...
 a30:	eb 38                	jmp    a6a <malloc+0xde>
    ...
    if(p == freep)
 a32:	a1 40 12 00 00       	mov    0x1240,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 b10:	c7 44 24 04 14 0e 00 	movl   $0xe14,0x4(%esp)
 b17:	00 
 ...
 b55:	c7 44 24 04 22 0e 00 	movl   $0xe22,0x4(%esp)
 b5c:	00 
 ...
 b81:	c7 44 24 04 2f 0e 00 	movl   $0xe2f,0x4(%esp)
 b88:	00 
...
void init_q(struct queue *q){
 ...
 ba2:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
 ba8:	8b 45 08             	mov    0x8(%ebp),%eax
 bab:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
 bb2:	8b 45 08             	mov    0x8(%ebp),%eax
 bb5:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
 bbc:	5d                   	pop    %ebp
 bbd:	c3                   	ret    
...
void add_q(struct queue *q, int v){
 ...
 bc4:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
 bcb:	e8 bc fd ff ff       	call   98c <malloc>
...
int empty_q(struct queue *q){
 ...
 c28:	75 07                	jne    c31 <empty_q+0x13>
        return 1;
 c2a:	b8 01 00 00 00       	mov    $0x1,%eax
 c2f:	eb 05                	jmp    c36 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
 ...
 c44:	e8 d5 ff ff ff       	call   c1e <empty_q>
 c49:	85 c0                	test   %eax,%eax
 c4b:	75 5d                	jne    caa <pop_q+0x72>
       val = q->head->value; 
 ...
 c76:	e8 d8 fb ff ff       	call   853 <free>
       q->size--;
 ...
 c8f:	75 14                	jne    ca5 <pop_q+0x6d>
            q->head = 0;
 c91:	8b 45 08             	mov    0x8(%ebp),%eax
 c94:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
 c9b:	8b 45 08             	mov    0x8(%ebp),%eax
 c9e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
 ca5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ca8:	eb 05                	jmp    caf <pop_q+0x77>
    }
    return -1;
 caa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 caf:	c9                   	leave  
 cb0:	c3                   	ret    
...
sem_init(struct semaphore *s, int size){
 ...
 cd0:	e8 b1 fd ff ff       	call   a86 <lock_init>
}
 cd5:	c9                   	leave  
 cd6:	c3                   	ret    
...
sem_aquire(struct semaphore * s){
 ...
 ce3:	e8 ac fd ff ff       	call   a94 <lock_acquire>
	if(s->count  == 0){
 ce8:	8b 45 08             	mov    0x8(%ebp),%eax
 ceb:	8b 40 04             	mov    0x4(%eax),%eax
 cee:	85 c0                	test   %eax,%eax
 cf0:	75 2f                	jne    d21 <sem_aquire+0x4a>
		//add proc to waiters list
		int tid = getpid();
 cf2:	e8 81 f8 ff ff       	call   578 <getpid>
...
sem_signal(struct semaphore * s){
 ...
 d40:	83 ec 28             	sub    $0x28,%esp
	//If count is full then place proccess on waiters list
	lock_acquire(&s->lock);
 d43:	8b 45 08             	mov    0x8(%ebp),%eax
 d46:	89 04 24             	mov    %eax,(%esp)
 d49:	e8 46 fd ff ff       	call   a94 <lock_acquire>
	if(s->count < s->size){
 d4e:	8b 45 08             	mov    0x8(%ebp),%eax
 d51:	8b 50 04             	mov    0x4(%eax),%edx
 d54:	8b 45 08             	mov    0x8(%ebp),%eax
 d57:	8b 40 08             	mov    0x8(%eax),%eax
 d5a:	39 c2                	cmp    %eax,%edx
 d5c:	7d 40                	jge    d9e <sem_signal+0x61>
		int tid;
		tid = pop_q(&s->waiters);
 d5e:	8b 45 08             	mov    0x8(%ebp),%eax
 d61:	83 c0 0c             	add    $0xc,%eax
 d64:	89 04 24             	mov    %eax,(%esp)
 d67:	e8 cc fe ff ff       	call   c38 <pop_q>
 d6c:	89 45 f4             	mov    %eax,-0xc(%ebp)
		if(tid != -1) twakeup(tid);
 d6f:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 d73:	74 0d                	je     d82 <sem_signal+0x45>
 d75:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d78:	89 04 24             	mov    %eax,(%esp)
 d7b:	e8 30 f8 ff ff       	call   5b0 <twakeup>
 d80:	eb 0f                	jmp    d91 <sem_signal+0x54>
		else s->count++;	
 d82:	8b 45 08             	mov    0x8(%ebp),%eax
 d85:	8b 40 04             	mov    0x4(%eax),%eax
 d88:	8d 50 01             	lea    0x1(%eax),%edx
 d8b:	8b 45 08             	mov    0x8(%ebp),%eax
 d8e:	89 50 04             	mov    %edx,0x4(%eax)
		lock_release(&s->lock);
 d91:	8b 45 08             	mov    0x8(%ebp),%eax
 d94:	89 04 24             	mov    %eax,(%esp)
 d97:	e8 18 fd ff ff       	call   ab4 <lock_release>
 d9c:	eb 27                	jmp    dc5 <sem_signal+0x88>
	}
	else{
		int tid;
		tid = pop_q(&s->waiters);
 d9e:	8b 45 08             	mov    0x8(%ebp),%eax
 da1:	83 c0 0c             	add    $0xc,%eax
 da4:	89 04 24             	mov    %eax,(%esp)
 da7:	e8 8c fe ff ff       	call   c38 <pop_q>
 dac:	89 45 f0             	mov    %eax,-0x10(%ebp)
		twakeup(tid);
 daf:	8b 45 f0             	mov    -0x10(%ebp),%eax
 db2:	89 04 24             	mov    %eax,(%esp)
 db5:	e8 f6 f7 ff ff       	call   5b0 <twakeup>
		lock_release(&s->lock);
 dba:	8b 45 08             	mov    0x8(%ebp),%eax
 dbd:	89 04 24             	mov    %eax,(%esp)
 dc0:	e8 ef fc ff ff       	call   ab4 <lock_release>
	}
