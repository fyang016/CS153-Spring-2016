...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 b0 0b 00 	movl   $0xbb0,0x4(%esp)
  16:	00 
  ...
  60:	c7 44 24 04 c3 0b 00 	movl   $0xbc3,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	0f b6 80 d0 0f 00 00 	movzbl 0xfd0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 57f:	75 09                	jne    58a <printf+0x101>
          s = "(null)";
 581:	c7 45 f4 d7 0b 00 00 	movl   $0xbd7,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64b:	a1 ec 0f 00 00       	mov    0xfec,%eax
...
free(void *ap)
{
 ...
 716:	a3 ec 0f 00 00       	mov    %eax,0xfec
}
 71b:	c9                   	leave  
 71c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 769:	e8 ce fe ff ff       	call   63c <free>
  return freep;
 76e:	a1 ec 0f 00 00       	mov    0xfec,%eax
}
 773:	c9                   	leave  
 774:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 787:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 78a:	a1 ec 0f 00 00       	mov    0xfec,%eax
 78f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 792:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 796:	75 23                	jne    7bb <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 798:	c7 45 f0 e4 0f 00 00 	movl   $0xfe4,-0x10(%ebp)
 79f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a2:	a3 ec 0f 00 00       	mov    %eax,0xfec
 7a7:	a1 ec 0f 00 00       	mov    0xfec,%eax
 7ac:	a3 e4 0f 00 00       	mov    %eax,0xfe4
    base.s.size = 0;
 7b1:	c7 05 e8 0f 00 00 00 	movl   $0x0,0xfe8
 7b8:	00 00 00 
  }
 ...
 80e:	a3 ec 0f 00 00       	mov    %eax,0xfec
      return (void*)(p + 1);
 ...
 819:	eb 38                	jmp    853 <malloc+0xde>
    ...
    if(p == freep)
 81b:	a1 ec 0f 00 00       	mov    0xfec,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8f9:	c7 44 24 04 de 0b 00 	movl   $0xbde,0x4(%esp)
 900:	00 
 ...
 93e:	c7 44 24 04 ec 0b 00 	movl   $0xbec,0x4(%esp)
 945:	00 
 ...
 96a:	c7 44 24 04 f9 0b 00 	movl   $0xbf9,0x4(%esp)
 971:	00 
...
sem_aquire(struct semaphore * s){
 ...
 ad9:	75 2f                	jne    b0a <sem_aquire+0x4a>
		//add proc to waiters list
		int tid = getpid();
 adb:	e8 81 f8 ff ff       	call   361 <getpid>
...
sem_signal(struct semaphore * s){
 ...
 b32:	e8 46 fd ff ff       	call   87d <lock_acquire>
	if(s->count < s->size){
