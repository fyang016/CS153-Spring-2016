...
runcmd(struct cmd *cmd)
{
  ...
  default:
    panic("runcmd");
      24:	c7 04 24 30 18 00 00 	movl   $0x1830,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 37 18 00 	movl   $0x1837,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 47 18 00 	movl   $0x1847,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 57 18 00 00 	movl   $0x1857,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 74 18 00 	movl   $0x1874,0x4(%esp)
     218:	00 
     ...
     287:	eb 1f                	jmp    2a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     290:	00 
     291:	c7 04 24 77 18 00 00 	movl   $0x1877,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     2fb:	00 
     2fc:	c7 44 24 04 7f 18 00 	movl   $0x187f,0x4(%esp)
     303:	00 
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     364:	c7 44 24 04 8d 18 00 	movl   $0x188d,0x4(%esp)
     36b:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     391:	c7 04 24 91 18 00 00 	movl   $0x1891,(%esp)
     ...
     542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55b:	c7 04 24 54 1f 00 00 	movl   $0x1f54,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     605:	c7 04 24 54 1f 00 00 	movl   $0x1f54,(%esp)
     ...
     622:	c7 04 24 5a 1f 00 00 	movl   $0x1f5a,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 54 1f 00 00 	movl   $0x1f54,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 54 1f 00 00 	movl   $0x1f54,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 96 18 00 	movl   $0x1896,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 97 18 00 	movl   $0x1897,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 ab 09 00 00       	call   1109 <printf>
    panic("syntax");
     75e:	c7 04 24 a6 18 00 00 	movl   $0x18a6,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 ad 18 00 	movl   $0x18ad,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 af 18 00 	movl   $0x18af,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 b1 18 00 	movl   $0x18b1,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 b3 18 00 00 	movl   $0x18b3,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 d0 18 00 	movl   $0x18d0,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 d3 18 00 	movl   $0x18d3,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 d5 18 00 00 	movl   $0x18d5,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 e0 18 00 	movl   $0x18e0,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 e2 18 00 00 	movl   $0x18e2,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 d3 18 00 	movl   $0x18d3,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b75:	74 0c                	je     b83 <parseexec+0xb1>
      panic("syntax");
     b77:	c7 04 24 a6 18 00 00 	movl   $0x18a6,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba8:	7e 0c                	jle    bb6 <parseexec+0xe4>
      panic("too many args");
     baa:	c7 04 24 f5 18 00 00 	movl   $0x18f5,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd2:	c7 44 24 08 03 19 00 	movl   $0x1903,0x8(%esp)
     bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3c:	8b 04 85 08 19 00 00 	mov    0x1908(,%eax,4),%eax
     c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    10a2:	0f b6 80 62 1f 00 00 	movzbl 0x1f62(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11ff:	75 09                	jne    120a <printf+0x101>
          s = "(null)";
    1201:	c7 45 f4 20 19 00 00 	movl   $0x1920,-0xc(%ebp)
        while(*s != 0){
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1579:	c7 44 24 04 27 19 00 	movl   $0x1927,0x4(%esp)
    1580:	00 
    ...
    15be:	c7 44 24 04 35 19 00 	movl   $0x1935,0x4(%esp)
    15c5:	00 
    ...
    15ea:	c7 44 24 04 42 19 00 	movl   $0x1942,0x4(%esp)
    15f1:	00 
...
sem_signal(struct semaphore * s){
    ...
    17c5:	7d 40                	jge    1807 <sem_signal+0x61>
		int tid;
		tid = pop_q(&s->waiters);
    17c7:	8b 45 08             	mov    0x8(%ebp),%eax
    17ca:	83 c0 0c             	add    $0xc,%eax
    17cd:	89 04 24             	mov    %eax,(%esp)
    17d0:	e8 cc fe ff ff       	call   16a1 <pop_q>
    17d5:	89 45 f4             	mov    %eax,-0xc(%ebp)
		if(tid != -1) twakeup(tid);
    17d8:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    17dc:	74 0d                	je     17eb <sem_signal+0x45>
    17de:	8b 45 f4             	mov    -0xc(%ebp),%eax
    17e1:	89 04 24             	mov    %eax,(%esp)
    17e4:	e8 30 f8 ff ff       	call   1019 <twakeup>
    17e9:	eb 0f                	jmp    17fa <sem_signal+0x54>
		else s->count++;	
    17eb:	8b 45 08             	mov    0x8(%ebp),%eax
    17ee:	8b 40 04             	mov    0x4(%eax),%eax
    17f1:	8d 50 01             	lea    0x1(%eax),%edx
    17f4:	8b 45 08             	mov    0x8(%ebp),%eax
    17f7:	89 50 04             	mov    %edx,0x4(%eax)
		lock_release(&s->lock);
    17fa:	8b 45 08             	mov    0x8(%ebp),%eax
    17fd:	89 04 24             	mov    %eax,(%esp)
    1800:	e8 18 fd ff ff       	call   151d <lock_release>
    1805:	eb 27                	jmp    182e <sem_signal+0x88>
	}
	else{
		int tid;
		tid = pop_q(&s->waiters);
    1807:	8b 45 08             	mov    0x8(%ebp),%eax
    180a:	83 c0 0c             	add    $0xc,%eax
    180d:	89 04 24             	mov    %eax,(%esp)
    1810:	e8 8c fe ff ff       	call   16a1 <pop_q>
    1815:	89 45 f0             	mov    %eax,-0x10(%ebp)
		twakeup(tid);
    1818:	8b 45 f0             	mov    -0x10(%ebp),%eax
    181b:	89 04 24             	mov    %eax,(%esp)
    181e:	e8 f6 f7 ff ff       	call   1019 <twakeup>
		lock_release(&s->lock);
    1823:	8b 45 08             	mov    0x8(%ebp),%eax
    1826:	89 04 24             	mov    %eax,(%esp)
    1829:	e8 ef fc ff ff       	call   151d <lock_release>
	}
