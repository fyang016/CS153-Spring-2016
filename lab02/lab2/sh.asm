...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 84 18 00 00 	mov    0x1884(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 58 18 00 00 	movl   $0x1858,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 5f 18 00 	movl   $0x185f,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 6f 18 00 	movl   $0x186f,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 7f 18 00 00 	movl   $0x187f,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20e:	c7 44 24 04 9c 18 00 	movl   $0x189c,0x4(%esp)
     215:	00 
     ...
     285:	e9 ae 00 00 00       	jmp    338 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     291:	00 
     292:	c7 04 24 9f 18 00 00 	movl   $0x189f,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2ae:	0f b6 05 c0 19 00 00 	movzbl 0x19c0,%eax
     2b5:	3c 63                	cmp    $0x63,%al
     2b7:	75 5a                	jne    313 <main+0xad>
     2b9:	0f b6 05 c1 19 00 00 	movzbl 0x19c1,%eax
     2c0:	3c 64                	cmp    $0x64,%al
     2c2:	75 4f                	jne    313 <main+0xad>
     2c4:	0f b6 05 c2 19 00 00 	movzbl 0x19c2,%eax
     2cb:	3c 20                	cmp    $0x20,%al
     2cd:	75 44                	jne    313 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2cf:	c7 04 24 c0 19 00 00 	movl   $0x19c0,(%esp)
     2d6:	e8 b6 0a 00 00       	call   d91 <strlen>
     2db:	83 e8 01             	sub    $0x1,%eax
     2de:	c6 80 c0 19 00 00 00 	movb   $0x0,0x19c0(%eax)
      if(chdir(buf+3) < 0)
     2e5:	c7 04 24 c3 19 00 00 	movl   $0x19c3,(%esp)
     2ec:	e8 db 0c 00 00       	call   fcc <chdir>
     2f1:	85 c0                	test   %eax,%eax
     2f3:	79 42                	jns    337 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f5:	c7 44 24 08 c3 19 00 	movl   $0x19c3,0x8(%esp)
     2fc:	00 
     2fd:	c7 44 24 04 a7 18 00 	movl   $0x18a7,0x4(%esp)
     304:	00 
    ...
    if(fork1() == 0)
     ...
     31a:	75 14                	jne    330 <main+0xca>
      runcmd(parsecmd(buf));
     31c:	c7 04 24 c0 19 00 00 	movl   $0x19c0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     33f:	00 
     340:	c7 04 24 c0 19 00 00 	movl   $0x19c0,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     366:	c7 44 24 04 b5 18 00 	movl   $0x18b5,0x4(%esp)
     36d:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     393:	c7 04 24 b9 18 00 00 	movl   $0x18b9,(%esp)
     ...
     544:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55d:	c7 04 24 90 19 00 00 	movl   $0x1990,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     600:	c7 04 24 90 19 00 00 	movl   $0x1990,(%esp)
     ...
     61d:	c7 04 24 96 19 00 00 	movl   $0x1996,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     65c:	c7 04 24 90 19 00 00 	movl   $0x1990,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a2:	c7 04 24 90 19 00 00 	movl   $0x1990,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     71e:	c7 44 24 08 be 18 00 	movl   $0x18be,0x8(%esp)
     725:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     747:	c7 44 24 04 bf 18 00 	movl   $0x18bf,0x4(%esp)
     74e:	00 
     74f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     756:	e8 a2 09 00 00       	call   10fd <printf>
    panic("syntax");
     75b:	c7 04 24 ce 18 00 00 	movl   $0x18ce,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7c8:	c7 44 24 08 d5 18 00 	movl   $0x18d5,0x8(%esp)
     7cf:	00 
  ...
  if(peek(ps, es, ";")){
     7e6:	c7 44 24 08 d7 18 00 	movl   $0x18d7,0x8(%esp)
     7ed:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86a:	c7 44 24 08 d9 18 00 	movl   $0x18d9,0x8(%esp)
     871:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     928:	c7 04 24 db 18 00 00 	movl   $0x18db,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d3:	c7 44 24 08 f8 18 00 	movl   $0x18f8,0x8(%esp)
     9da:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a00:	c7 44 24 08 fb 18 00 	movl   $0x18fb,0x8(%esp)
     a07:	00 
    ...
    panic("parseblock");
     a1e:	c7 04 24 fd 18 00 00 	movl   $0x18fd,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a61:	c7 44 24 08 08 19 00 	movl   $0x1908,0x8(%esp)
     a68:	00 
    ...
    panic("syntax - missing )");
     a7f:	c7 04 24 0a 19 00 00 	movl   $0x190a,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad4:	c7 44 24 08 fb 18 00 	movl   $0x18fb,0x8(%esp)
     adb:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b70:	74 0c                	je     b7e <parseexec+0xb0>
      panic("syntax");
     b72:	c7 04 24 ce 18 00 00 	movl   $0x18ce,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba3:	7e 0c                	jle    bb1 <parseexec+0xe3>
      panic("too many args");
     ba5:	c7 04 24 1d 19 00 00 	movl   $0x191d,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bcd:	c7 44 24 08 2b 19 00 	movl   $0x192b,0x8(%esp)
     bd4:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3a:	8b 04 85 30 19 00 00 	mov    0x1930(,%eax,4),%eax
     c41:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1096:	0f b6 80 a0 19 00 00 	movzbl 0x19a0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11f4:	75 27                	jne    121d <printf+0x120>
          s = "(null)";
    11f6:	c7 45 e4 48 19 00 00 	movl   $0x1948,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12c3:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1384:	a3 2c 1a 00 00       	mov    %eax,0x1a2c
}
    1389:	c9                   	leave  
    138a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13dc:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
}
    13e1:	c9                   	leave  
    13e2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    13f8:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
    13fd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1400:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1404:	75 23                	jne    1429 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1406:	c7 45 f0 24 1a 00 00 	movl   $0x1a24,-0x10(%ebp)
    140d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1410:	a3 2c 1a 00 00       	mov    %eax,0x1a2c
    1415:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
    141a:	a3 24 1a 00 00       	mov    %eax,0x1a24
    base.s.size = 0;
    141f:	c7 05 28 1a 00 00 00 	movl   $0x0,0x1a28
    1426:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    147c:	a3 2c 1a 00 00       	mov    %eax,0x1a2c
      return (void*)(p + 1);
    ...
    if(p == freep)
    1489:	a1 2c 1a 00 00       	mov    0x1a2c,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1568:	c7 44 24 04 4f 19 00 	movl   $0x194f,0x4(%esp)
    156f:	00 
    ...
    15ad:	c7 44 24 04 5d 19 00 	movl   $0x195d,0x4(%esp)
    15b4:	00 
    ...
    15d9:	c7 44 24 04 6a 19 00 	movl   $0x196a,0x4(%esp)
    15e0:	00 
...
sem_aquire(struct semaphore * s){
    ...
    173e:	e8 a9 fd ff ff       	call   14ec <lock_acquire>
	if(s->count  == 0){
    1743:	8b 45 08             	mov    0x8(%ebp),%eax
    1746:	8b 40 04             	mov    0x4(%eax),%eax
    1749:	85 c0                	test   %eax,%eax
    174b:	75 43                	jne    1790 <sem_aquire+0x5e>
  		printf(1, "Sem F\n");
    174d:	c7 44 24 04 7b 19 00 	movl   $0x197b,0x4(%esp)
    1754:	00 
    1755:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    175c:	e8 9c f9 ff ff       	call   10fd <printf>
		//add proc to waiters list
		int tid = getpid();
    1761:	e8 76 f8 ff ff       	call   fdc <getpid>
    ...
    176c:	8d 50 0c             	lea    0xc(%eax),%edx
    176f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1772:	89 44 24 04          	mov    %eax,0x4(%esp)
    1776:	89 14 24             	mov    %edx,(%esp)
    1779:	e8 98 fe ff ff       	call   1616 <add_q>
		//printf(1, "		Added to waiters semaphore with size: %d\n", s->size);
		lock_release(&s->lock);
    177e:	8b 45 08             	mov    0x8(%ebp),%eax
    1781:	89 04 24             	mov    %eax,(%esp)
    1784:	e8 82 fd ff ff       	call   150b <lock_release>
		tsleep(); 
    1789:	e8 7e f8 ff ff       	call   100c <tsleep>
    178e:	eb 2e                	jmp    17be <sem_aquire+0x8c>
	}
	else{
  		printf(1, "Sem A\n");
    1790:	c7 44 24 04 82 19 00 	movl   $0x1982,0x4(%esp)
    1797:	00 
    1798:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    179f:	e8 59 f9 ff ff       	call   10fd <printf>
		s->count--;	
    17a4:	8b 45 08             	mov    0x8(%ebp),%eax
    17a7:	8b 40 04             	mov    0x4(%eax),%eax
    17aa:	8d 50 ff             	lea    -0x1(%eax),%edx
    17ad:	8b 45 08             	mov    0x8(%ebp),%eax
    17b0:	89 50 04             	mov    %edx,0x4(%eax)
		lock_release(&s->lock);
    17b3:	8b 45 08             	mov    0x8(%ebp),%eax
    17b6:	89 04 24             	mov    %eax,(%esp)
    17b9:	e8 4d fd ff ff       	call   150b <lock_release>
	}
}
    17be:	c9                   	leave  
    17bf:	c3                   	ret    
...
sem_signal(struct semaphore * s){
    ...
    17c3:	83 ec 28             	sub    $0x28,%esp
	printf(1, "Sem R\n");
    17c6:	c7 44 24 04 89 19 00 	movl   $0x1989,0x4(%esp)
    17cd:	00 
    17ce:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17d5:	e8 23 f9 ff ff       	call   10fd <printf>
	//If count is full then place proccess on waiters list
	lock_acquire(&s->lock);
    17da:	8b 45 08             	mov    0x8(%ebp),%eax
    17dd:	89 04 24             	mov    %eax,(%esp)
    17e0:	e8 07 fd ff ff       	call   14ec <lock_acquire>
	if(s->count < s->size){
    17e5:	8b 45 08             	mov    0x8(%ebp),%eax
    17e8:	8b 50 04             	mov    0x4(%eax),%edx
    17eb:	8b 45 08             	mov    0x8(%ebp),%eax
    17ee:	8b 40 08             	mov    0x8(%eax),%eax
    17f1:	39 c2                	cmp    %eax,%edx
    17f3:	7d 0f                	jge    1804 <sem_signal+0x44>
		s->count++;	
    17f5:	8b 45 08             	mov    0x8(%ebp),%eax
    17f8:	8b 40 04             	mov    0x4(%eax),%eax
    17fb:	8d 50 01             	lea    0x1(%eax),%edx
    ...
    1807:	83 c0 0c             	add    $0xc,%eax
    180a:	89 04 24             	mov    %eax,(%esp)
    180d:	e8 7e fe ff ff       	call   1690 <pop_q>
    1812:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if(tid != -1){
    1815:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1819:	74 2e                	je     1849 <sem_signal+0x89>
		printf(1, "Sem A\n");
    181b:	c7 44 24 04 82 19 00 	movl   $0x1982,0x4(%esp)
    1822:	00 
    1823:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    182a:	e8 ce f8 ff ff       	call   10fd <printf>
		twakeup(tid);
    182f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1832:	89 04 24             	mov    %eax,(%esp)
    1835:	e8 da f7 ff ff       	call   1014 <twakeup>
		s->count--;
    183a:	8b 45 08             	mov    0x8(%ebp),%eax
    183d:	8b 40 04             	mov    0x4(%eax),%eax
    1840:	8d 50 ff             	lea    -0x1(%eax),%edx
    1843:	8b 45 08             	mov    0x8(%ebp),%eax
    1846:	89 50 04             	mov    %edx,0x4(%eax)
	}
	lock_release(&s->lock);
    1849:	8b 45 08             	mov    0x8(%ebp),%eax
    184c:	89 04 24             	mov    %eax,(%esp)
    184f:	e8 b7 fc ff ff       	call   150b <lock_release>
