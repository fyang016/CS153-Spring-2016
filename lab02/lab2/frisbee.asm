...
//    void * sp;
  ...
  1a:	c7 44 24 04 3c 0f 00 	movl   $0xf3c,0x4(%esp)
  21:	00 
 ...
 117:	c7 44 24 04 51 0f 00 	movl   $0xf51,0x4(%esp)
 11e:	00 
 ...
 134:	c7 44 24 04 66 0f 00 	movl   $0xf66,0x4(%esp)
 13b:	00 
 ...
 16e:	c7 44 24 04 7a 0f 00 	movl   $0xf7a,0x4(%esp)
 175:	00 
...
//    sleep(5);
 ...
 1dc:	c7 44 24 04 90 0f 00 	movl   $0xf90,0x4(%esp)
 1e3:	00 
...
void pass_next(void *arg){
 ...
 2bd:	c7 44 24 04 b8 0f 00 	movl   $0xfb8,0x4(%esp)
 2c4:	00 
...
leaving: 
 ...
 345:	c7 44 24 04 04 10 00 	movl   $0x1004,0x4(%esp)
 34c:	00 
 ...
 393:	c7 44 24 04 d0 0f 00 	movl   $0xfd0,0x4(%esp)
 39a:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7ab:	0f b6 80 60 14 00 00 	movzbl 0x1460(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 908:	75 09                	jne    913 <printf+0x101>
          s = "(null)";
 90a:	c7 45 f4 1b 10 00 00 	movl   $0x101b,-0xc(%ebp)
        while(*s != 0){
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 c82:	c7 44 24 04 22 10 00 	movl   $0x1022,0x4(%esp)
 c89:	00 
 ...
 cc7:	c7 44 24 04 30 10 00 	movl   $0x1030,0x4(%esp)
 cce:	00 
 ...
 cf3:	c7 44 24 04 3d 10 00 	movl   $0x103d,0x4(%esp)
 cfa:	00 
...
sem_signal(struct semaphore * s){
 ...
 ece:	7d 40                	jge    f10 <sem_signal+0x61>
		int tid;
		tid = pop_q(&s->waiters);
 ed0:	8b 45 08             	mov    0x8(%ebp),%eax
 ed3:	83 c0 0c             	add    $0xc,%eax
 ed6:	89 04 24             	mov    %eax,(%esp)
 ed9:	e8 cc fe ff ff       	call   daa <pop_q>
 ede:	89 45 f4             	mov    %eax,-0xc(%ebp)
		if(tid != -1) twakeup(tid);
 ee1:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 ee5:	74 0d                	je     ef4 <sem_signal+0x45>
 ee7:	8b 45 f4             	mov    -0xc(%ebp),%eax
 eea:	89 04 24             	mov    %eax,(%esp)
 eed:	e8 30 f8 ff ff       	call   722 <twakeup>
 ef2:	eb 0f                	jmp    f03 <sem_signal+0x54>
		else s->count++;	
 ef4:	8b 45 08             	mov    0x8(%ebp),%eax
 ef7:	8b 40 04             	mov    0x4(%eax),%eax
 efa:	8d 50 01             	lea    0x1(%eax),%edx
 efd:	8b 45 08             	mov    0x8(%ebp),%eax
 f00:	89 50 04             	mov    %edx,0x4(%eax)
		lock_release(&s->lock);
 f03:	8b 45 08             	mov    0x8(%ebp),%eax
 f06:	89 04 24             	mov    %eax,(%esp)
 f09:	e8 18 fd ff ff       	call   c26 <lock_release>
 f0e:	eb 27                	jmp    f37 <sem_signal+0x88>
	}
	else{
		int tid;
		tid = pop_q(&s->waiters);
 f10:	8b 45 08             	mov    0x8(%ebp),%eax
 f13:	83 c0 0c             	add    $0xc,%eax
 f16:	89 04 24             	mov    %eax,(%esp)
 f19:	e8 8c fe ff ff       	call   daa <pop_q>
 f1e:	89 45 f0             	mov    %eax,-0x10(%ebp)
		twakeup(tid);
 f21:	8b 45 f0             	mov    -0x10(%ebp),%eax
 f24:	89 04 24             	mov    %eax,(%esp)
 f27:	e8 f6 f7 ff ff       	call   722 <twakeup>
		lock_release(&s->lock);
 f2c:	8b 45 08             	mov    0x8(%ebp),%eax
 f2f:	89 04 24             	mov    %eax,(%esp)
 f32:	e8 ef fc ff ff       	call   c26 <lock_release>
	}
