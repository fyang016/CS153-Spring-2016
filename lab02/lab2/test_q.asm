...
int main(){
  ...
  61:	c7 44 24 04 c1 0b 00 	movl   $0xbc1,0x4(%esp)
  68:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 433:	0f b6 80 c0 0f 00 00 	movzbl 0xfc0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 590:	75 09                	jne    59b <printf+0x101>
          s = "(null)";
 592:	c7 45 f4 c9 0b 00 00 	movl   $0xbc9,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 65c:	a1 dc 0f 00 00       	mov    0xfdc,%eax
...
free(void *ap)
{
 ...
 727:	a3 dc 0f 00 00       	mov    %eax,0xfdc
}
 72c:	c9                   	leave  
 72d:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 77a:	e8 ce fe ff ff       	call   64d <free>
  return freep;
 77f:	a1 dc 0f 00 00       	mov    0xfdc,%eax
}
 784:	c9                   	leave  
 785:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 798:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 79b:	a1 dc 0f 00 00       	mov    0xfdc,%eax
 7a0:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a7:	75 23                	jne    7cc <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a9:	c7 45 f0 d4 0f 00 00 	movl   $0xfd4,-0x10(%ebp)
 7b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b3:	a3 dc 0f 00 00       	mov    %eax,0xfdc
 7b8:	a1 dc 0f 00 00       	mov    0xfdc,%eax
 7bd:	a3 d4 0f 00 00       	mov    %eax,0xfd4
    base.s.size = 0;
 7c2:	c7 05 d8 0f 00 00 00 	movl   $0x0,0xfd8
 7c9:	00 00 00 
  }
 ...
 81f:	a3 dc 0f 00 00       	mov    %eax,0xfdc
      return (void*)(p + 1);
 ...
 82a:	eb 38                	jmp    864 <malloc+0xde>
    ...
    if(p == freep)
 82c:	a1 dc 0f 00 00       	mov    0xfdc,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 90a:	c7 44 24 04 d0 0b 00 	movl   $0xbd0,0x4(%esp)
 911:	00 
 ...
 94f:	c7 44 24 04 de 0b 00 	movl   $0xbde,0x4(%esp)
 956:	00 
 ...
 97b:	c7 44 24 04 eb 0b 00 	movl   $0xbeb,0x4(%esp)
 982:	00 
...
sem_aquire(struct semaphore * s){
 ...
 aea:	75 2f                	jne    b1b <sem_aquire+0x4a>
		//add proc to waiters list
		int tid = getpid();
 aec:	e8 81 f8 ff ff       	call   372 <getpid>
...
sem_signal(struct semaphore * s){
 ...
 b91:	e8 18 fd ff ff       	call   8ae <lock_release>
 b96:	eb 27                	jmp    bbf <sem_signal+0x88>
	}
	else{
		int tid;
		tid = pop_q(&s->waiters);
