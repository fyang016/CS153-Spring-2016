...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 e4 63 00 00       	mov    0x63e4,%eax
       b:	c7 44 24 04 f6 44 00 	movl   $0x44f6,0x4(%esp)
      12:	00 
  ...
  fd = open("echo", 0);
      ...
      22:	00 
      23:	c7 04 24 e0 44 00 00 	movl   $0x44e0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 e4 63 00 00       	mov    0x63e4,%eax
      3d:	c7 44 24 04 01 45 00 	movl   $0x4501,0x4(%esp)
      44:	00 
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 14 45 00 00 	movl   $0x4514,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 e4 63 00 00       	mov    0x63e4,%eax
      7f:	c7 44 24 04 21 45 00 	movl   $0x4521,0x4(%esp)
      86:	00 
  ...
  printf(stdout, "open test ok\n");
      94:	a1 e4 63 00 00       	mov    0x63e4,%eax
      99:	c7 44 24 04 3f 45 00 	movl   $0x453f,0x4(%esp)
      a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 e4 63 00 00       	mov    0x63e4,%eax
      b6:	c7 44 24 04 4d 45 00 	movl   $0x454d,0x4(%esp)
      bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      cd:	00 
      ce:	c7 04 24 5e 45 00 00 	movl   $0x455e,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 e4 63 00 00       	mov    0x63e4,%eax
      e8:	c7 44 24 04 64 45 00 	movl   $0x4564,0x4(%esp)
      ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 e4 63 00 00       	mov    0x63e4,%eax
     109:	c7 44 24 04 7f 45 00 	movl   $0x457f,0x4(%esp)
     110:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 9b 45 00 	movl   $0x459b,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 e4 63 00 00       	mov    0x63e4,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 a8 45 00 	movl   $0x45a8,0x4(%esp)
     151:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 cc 45 00 	movl   $0x45cc,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 e4 63 00 00       	mov    0x63e4,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 d8 45 00 	movl   $0x45d8,0x4(%esp)
     192:	00 
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 e4 63 00 00       	mov    0x63e4,%eax
     1b3:	c7 44 24 04 fc 45 00 	movl   $0x45fc,0x4(%esp)
     1ba:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 5e 45 00 00 	movl   $0x455e,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 e4 63 00 00       	mov    0x63e4,%eax
     1f0:	c7 44 24 04 07 46 00 	movl   $0x4607,0x4(%esp)
     1f7:	00 
  ...
  i = read(fd, buf, 2000);
     ...
     207:	00 
     208:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
     20f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 e4 63 00 00       	mov    0x63e4,%eax
     22e:	c7 44 24 04 20 46 00 	movl   $0x4620,0x4(%esp)
     235:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 e4 63 00 00       	mov    0x63e4,%eax
     248:	c7 44 24 04 3b 46 00 	movl   $0x463b,0x4(%esp)
     24f:	00 
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 5e 45 00 00 	movl   $0x455e,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 e4 63 00 00       	mov    0x63e4,%eax
     27a:	c7 44 24 04 4e 46 00 	movl   $0x464e,0x4(%esp)
     281:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 e4 63 00 00       	mov    0x63e4,%eax
     294:	c7 44 24 04 5b 46 00 	movl   $0x465b,0x4(%esp)
     29b:	00 
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 e4 63 00 00       	mov    0x63e4,%eax
     2ae:	c7 44 24 04 70 46 00 	movl   $0x4670,0x4(%esp)
     2b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 e4 63 00 00       	mov    0x63e4,%eax
     2cb:	c7 44 24 04 84 46 00 	movl   $0x4684,0x4(%esp)
     2d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e2:	00 
     2e3:	c7 04 24 94 46 00 00 	movl   $0x4694,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 e4 63 00 00       	mov    0x63e4,%eax
     2fd:	c7 44 24 04 98 46 00 	movl   $0x4698,0x4(%esp)
     304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 e4 63 00 00       	mov    0x63e4,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 b2 46 00 	movl   $0x46b2,0x4(%esp)
     35a:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 94 46 00 00 	movl   $0x4694,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 e4 63 00 00       	mov    0x63e4,%eax
     3a3:	c7 44 24 04 d0 46 00 	movl   $0x46d0,0x4(%esp)
     3aa:	00 
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c6:	00 
     3c7:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
     3ce:	00 
    ...
    if(i == 0){
     ...
     3ec:	a1 e4 63 00 00       	mov    0x63e4,%eax
     3f1:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f4:	89 54 24 08          	mov    %edx,0x8(%esp)
     3f8:	c7 44 24 04 e9 46 00 	movl   $0x46e9,0x4(%esp)
     3ff:	00 
  ...
  if(unlink("big") < 0){
     419:	c7 04 24 94 46 00 00 	movl   $0x4694,(%esp)
     ...
     438:	a1 e4 63 00 00       	mov    0x63e4,%eax
     43d:	8b 55 f4             	mov    -0xc(%ebp),%edx
     440:	89 54 24 08          	mov    %edx,0x8(%esp)
     444:	c7 44 24 04 06 47 00 	movl   $0x4706,0x4(%esp)
     44b:	00 
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     49a:	a1 e4 63 00 00       	mov    0x63e4,%eax
     49f:	c7 44 24 04 38 47 00 	movl   $0x4738,0x4(%esp)
     4a6:	00 
  ...
  printf(stdout, "big files ok\n");
     4b4:	a1 e4 63 00 00       	mov    0x63e4,%eax
     4b9:	c7 44 24 04 4b 47 00 	movl   $0x474b,0x4(%esp)
     4c0:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4d1:	a1 e4 63 00 00       	mov    0x63e4,%eax
     4d6:	c7 44 24 04 5c 47 00 	movl   $0x475c,0x4(%esp)
     4dd:	00 
     4de:	89 04 24             	mov    %eax,(%esp)
     4e1:	e8 da 38 00 00       	call   3dc0 <printf>

  name[0] = 'a';
     4e6:	c6 05 c0 ab 00 00 61 	movb   $0x61,0xabc0
  name[2] = '\0';
     4ed:	c6 05 c2 ab 00 00 00 	movb   $0x0,0xabc2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     503:	a2 c1 ab 00 00       	mov    %al,0xabc1
    fd = open(name, O_CREATE|O_RDWR);
     508:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50f:	00 
     510:	c7 04 24 c0 ab 00 00 	movl   $0xabc0,(%esp)
  ...
  name[0] = 'a';
     534:	c6 05 c0 ab 00 00 61 	movb   $0x61,0xabc0
  name[2] = '\0';
     53b:	c6 05 c2 ab 00 00 00 	movb   $0x0,0xabc2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     551:	a2 c1 ab 00 00       	mov    %al,0xabc1
    unlink(name);
     556:	c7 04 24 c0 ab 00 00 	movl   $0xabc0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56c:	a1 e4 63 00 00       	mov    0x63e4,%eax
     571:	c7 44 24 04 84 47 00 	movl   $0x4784,0x4(%esp)
     578:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     589:	a1 e4 63 00 00       	mov    0x63e4,%eax
     58e:	c7 44 24 04 aa 47 00 	movl   $0x47aa,0x4(%esp)
     595:	00 
     596:	89 04 24             	mov    %eax,(%esp)
     599:	e8 22 38 00 00       	call   3dc0 <printf>

  if(mkdir("dir0") < 0){
     59e:	c7 04 24 b6 47 00 00 	movl   $0x47b6,(%esp)
     5a5:	e8 d6 36 00 00       	call   3c80 <mkdir>
     5aa:	85 c0                	test   %eax,%eax
     5ac:	79 1a                	jns    5c8 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ae:	a1 e4 63 00 00       	mov    0x63e4,%eax
     5b3:	c7 44 24 04 bb 47 00 	movl   $0x47bb,0x4(%esp)
     5ba:	00 
  ...
  if(chdir("dir0") < 0){
     5c8:	c7 04 24 b6 47 00 00 	movl   $0x47b6,(%esp)
     5cf:	e8 b4 36 00 00       	call   3c88 <chdir>
     5d4:	85 c0                	test   %eax,%eax
     5d6:	79 1a                	jns    5f2 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d8:	a1 e4 63 00 00       	mov    0x63e4,%eax
     5dd:	c7 44 24 04 c9 47 00 	movl   $0x47c9,0x4(%esp)
     5e4:	00 
  ...
  if(chdir("..") < 0){
     5f2:	c7 04 24 dc 47 00 00 	movl   $0x47dc,(%esp)
     5f9:	e8 8a 36 00 00       	call   3c88 <chdir>
     5fe:	85 c0                	test   %eax,%eax
     600:	79 1a                	jns    61c <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     602:	a1 e4 63 00 00       	mov    0x63e4,%eax
     607:	c7 44 24 04 df 47 00 	movl   $0x47df,0x4(%esp)
     60e:	00 
  ...
  if(unlink("dir0") < 0){
     61c:	c7 04 24 b6 47 00 00 	movl   $0x47b6,(%esp)
     623:	e8 40 36 00 00       	call   3c68 <unlink>
     628:	85 c0                	test   %eax,%eax
     62a:	79 1a                	jns    646 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62c:	a1 e4 63 00 00       	mov    0x63e4,%eax
     631:	c7 44 24 04 f0 47 00 	movl   $0x47f0,0x4(%esp)
     638:	00 
  ...
  printf(stdout, "mkdir test\n");
     646:	a1 e4 63 00 00       	mov    0x63e4,%eax
     64b:	c7 44 24 04 aa 47 00 	movl   $0x47aa,0x4(%esp)
     652:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     663:	a1 e4 63 00 00       	mov    0x63e4,%eax
     668:	c7 44 24 04 04 48 00 	movl   $0x4804,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 48 37 00 00       	call   3dc0 <printf>
  if(exec("echo", echoargv) < 0){
     678:	c7 44 24 04 d0 63 00 	movl   $0x63d0,0x4(%esp)
     67f:	00 
     680:	c7 04 24 e0 44 00 00 	movl   $0x44e0,(%esp)
     687:	e8 c4 35 00 00       	call   3c50 <exec>
     68c:	85 c0                	test   %eax,%eax
     68e:	79 1a                	jns    6aa <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     690:	a1 e4 63 00 00       	mov    0x63e4,%eax
     695:	c7 44 24 04 0f 48 00 	movl   $0x480f,0x4(%esp)
     69c:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6c1:	c7 44 24 04 21 48 00 	movl   $0x4821,0x4(%esp)
     6c8:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     71c:	81 c2 c0 8b 00 00    	add    $0x8bc0,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     73b:	00 
     73c:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
     743:	00 
     ...
     753:	c7 44 24 04 30 48 00 	movl   $0x4830,0x4(%esp)
     75a:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7ac:	05 c0 8b 00 00       	add    $0x8bc0,%eax
     ...
     7c9:	c7 44 24 04 3e 48 00 	movl   $0x483e,0x4(%esp)
     7d0:	00 
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     812:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
     819:	00 
    ...
    if(total != 5 * 1033){
     ...
     83f:	c7 44 24 04 4c 48 00 	movl   $0x484c,0x4(%esp)
     846:	00 
  ...
  printf(1, "pipe1 ok\n");
     868:	c7 44 24 04 72 48 00 	movl   $0x4872,0x4(%esp)
     86f:	00 
    ...
    printf(1, "fork() failed\n");
     87e:	c7 44 24 04 63 48 00 	movl   $0x4863,0x4(%esp)
     885:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89f:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
     8a6:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     901:	00 
     902:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
     909:	00 
     ...
     917:	c7 44 24 04 88 48 00 	movl   $0x4888,0x4(%esp)
     91e:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94d:	00 
     94e:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
     955:	00 
    ...
    printf(1, "preempt read error");
     963:	c7 44 24 04 9c 48 00 	movl   $0x489c,0x4(%esp)
     96a:	00 
  ...
  printf(1, "kill... ");
     984:	c7 44 24 04 af 48 00 	movl   $0x48af,0x4(%esp)
     98b:	00 
  ...
  printf(1, "wait... ");
     9b9:	c7 44 24 04 b8 48 00 	movl   $0x48b8,0x4(%esp)
     9c0:	00 
  ...
  printf(1, "preempt ok\n");
     9dc:	c7 44 24 04 c1 48 00 	movl   $0x48c1,0x4(%esp)
     9e3:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0d:	79 16                	jns    a25 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0f:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
     a16:	00 
    ...
    if(pid){
     ...
     a35:	c7 44 24 04 da 48 00 	movl   $0x48da,0x4(%esp)
     a3c:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a5a:	c7 44 24 04 ea 48 00 	movl   $0x48ea,0x4(%esp)
     a61:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a76:	c7 44 24 04 f7 48 00 	movl   $0x48f7,0x4(%esp)
     a7d:	00 
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b06:	c7 44 24 04 01 49 00 	movl   $0x4901,0x4(%esp)
     b0d:	00 
    ...
    printf(1, "mem ok\n");
     b35:	c7 44 24 04 1b 49 00 	movl   $0x491b,0x4(%esp)
     b3c:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b98:	c7 44 24 04 3c 49 00 	movl   $0x493c,0x4(%esp)
     b9f:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c0a:	c7 44 24 04 68 49 00 	movl   $0x4968,0x4(%esp)
     c11:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     c4f:	00 
     c50:	c7 04 24 32 49 00 00 	movl   $0x4932,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c65:	c7 44 24 04 88 49 00 	movl   $0x4988,0x4(%esp)
     c6c:	00 
  ...
  unlink("sharedfd");
     cf6:	c7 04 24 32 49 00 00 	movl   $0x4932,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d14:	c7 44 24 04 b3 49 00 	movl   $0x49b3,0x4(%esp)
     d1b:	00 
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d38:	c7 44 24 04 c0 49 00 	movl   $0x49c0,0x4(%esp)
     d3f:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d59:	c7 44 24 04 d5 49 00 	movl   $0x49d5,0x4(%esp)
     d60:	00 
     d61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d68:	e8 53 30 00 00       	call   3dc0 <printf>

  unlink("f1");
     d6d:	c7 04 24 e4 49 00 00 	movl   $0x49e4,(%esp)
     d74:	e8 ef 2e 00 00       	call   3c68 <unlink>
  unlink("f2");
     d79:	c7 04 24 e7 49 00 00 	movl   $0x49e7,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d93:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
     d9a:	00 
  ...
  fname = pid ? "f1" : "f2";
     ...
     db2:	b8 e4 49 00 00       	mov    $0x49e4,%eax
     db7:	eb 05                	jmp    dbe <twofiles+0x6b>
     db9:	b8 e7 49 00 00       	mov    $0x49e7,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ddd:	c7 44 24 04 ea 49 00 	movl   $0x49ea,0x4(%esp)
     de4:	00 
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e14:	c7 04 24 c0 8b 00 00 	movl   $0x8bc0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e30:	00 
     e31:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
     e38:	00 
     ...
     e57:	c7 44 24 04 f9 49 00 	movl   $0x49f9,0x4(%esp)
     e5e:	00 
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea7:	b8 e4 49 00 00       	mov    $0x49e4,%eax
     eac:	eb 05                	jmp    eb3 <twofiles+0x160>
     eae:	b8 e7 49 00 00       	mov    $0x49e7,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     edb:	05 c0 8b 00 00       	add    $0x8bc0,%eax
     ...
     efa:	74 19                	je     f15 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     efc:	c7 44 24 04 0a 4a 00 	movl   $0x4a0a,0x4(%esp)
     f03:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f2e:	00 
     f2f:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
     f36:	00 
    ...
    if(total != 12*500){
     ...
     f66:	c7 44 24 04 16 4a 00 	movl   $0x4a16,0x4(%esp)
     f6d:	00 
  ...
  unlink("f1");
     f8d:	c7 04 24 e4 49 00 00 	movl   $0x49e4,(%esp)
     f94:	e8 cf 2c 00 00       	call   3c68 <unlink>
  unlink("f2");
     f99:	c7 04 24 e7 49 00 00 	movl   $0x49e7,(%esp)
     fa0:	e8 c3 2c 00 00       	call   3c68 <unlink>

  printf(1, "twofiles ok\n");
     fa5:	c7 44 24 04 27 4a 00 	movl   $0x4a27,0x4(%esp)
     fac:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fc1:	c7 44 24 04 34 4a 00 	movl   $0x4a34,0x4(%esp)
     fc8:	00 
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fe3:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
     fea:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    1044:	79 19                	jns    105f <createdelete+0xa4>
      printf(1, "create failed\n");
    1046:	c7 44 24 04 ea 49 00 	movl   $0x49ea,0x4(%esp)
    104d:	00 
    ...
    109b:	c7 44 24 04 47 4a 00 	movl   $0x4a47,0x4(%esp)
    10a2:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    111a:	c7 44 24 04 58 4a 00 	movl   $0x4a58,0x4(%esp)
    1121:	00 
    ...
    114c:	c7 44 24 04 7c 4a 00 	movl   $0x4a7c,0x4(%esp)
    1153:	00 
    ...
    11b2:	c7 44 24 04 58 4a 00 	movl   $0x4a58,0x4(%esp)
    11b9:	00 
    ...
    11e4:	c7 44 24 04 7c 4a 00 	movl   $0x4a7c,0x4(%esp)
    11eb:	00 
  ...
  printf(1, "createdelete ok\n");
    1256:	c7 44 24 04 9c 4a 00 	movl   $0x4a9c,0x4(%esp)
    125d:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1272:	c7 44 24 04 ad 4a 00 	movl   $0x4aad,0x4(%esp)
    1279:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    128d:	00 
    128e:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
  ...
  if(fd < 0){
    ...
    12a3:	c7 44 24 04 c9 4a 00 	movl   $0x4ac9,0x4(%esp)
    12aa:	00 
  ...
  write(fd, "hello", 5);
    ...
    12c3:	00 
    12c4:	c7 44 24 04 e3 4a 00 	movl   $0x4ae3,0x4(%esp)
    12cb:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e9:	00 
    12ea:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
  ...
  if(fd < 0){
    ...
    12ff:	c7 44 24 04 e9 4a 00 	movl   $0x4ae9,0x4(%esp)
    1306:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1385:	00 
    1386:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    138d:	00 
    ...
    139e:	c7 44 24 04 1f 4b 00 	movl   $0x4b1f,0x4(%esp)
    13a5:	00 
  ...
  if(buf[0] != 'h'){
    13b7:	0f b6 05 c0 8b 00 00 	movzbl 0x8bc0,%eax
    13be:	3c 68                	cmp    $0x68,%al
    13c0:	74 19                	je     13db <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13c2:	c7 44 24 04 36 4b 00 	movl   $0x4b36,0x4(%esp)
    13c9:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13e2:	00 
    13e3:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    13ea:	00 
    ...
    13fb:	c7 44 24 04 4d 4b 00 	movl   $0x4b4d,0x4(%esp)
    1402:	00 
  ...
  unlink("unlinkread");
    141f:	c7 04 24 be 4a 00 00 	movl   $0x4abe,(%esp)
    1426:	e8 3d 28 00 00       	call   3c68 <unlink>
  printf(1, "unlinkread ok\n");
    142b:	c7 44 24 04 66 4b 00 	movl   $0x4b66,0x4(%esp)
    1432:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    1490:	c7 44 24 04 87 4b 00 	movl   $0x4b87,0x4(%esp)
    1497:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14b0:	00 
    14b1:	c7 44 24 04 e3 4a 00 	movl   $0x4ae3,0x4(%esp)
    14b8:	00 
    ...
    14c9:	c7 44 24 04 9a 4b 00 	movl   $0x4b9a,0x4(%esp)
    14d0:	00 
  ...
  if(link("lf1", "lf2") < 0){
    14ed:	c7 44 24 04 83 4b 00 	movl   $0x4b83,0x4(%esp)
    14f4:	00 
    14f5:	c7 04 24 7f 4b 00 00 	movl   $0x4b7f,(%esp)
    14fc:	e8 77 27 00 00       	call   3c78 <link>
    1501:	85 c0                	test   %eax,%eax
    1503:	79 19                	jns    151e <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1505:	c7 44 24 04 ac 4b 00 	movl   $0x4bac,0x4(%esp)
    150c:	00 
  ...
  fd = open("lf2", 0);
    ...
    1562:	00 
    1563:	c7 04 24 83 4b 00 00 	movl   $0x4b83,(%esp)
  ...
  if(fd < 0){
    ...
    1578:	c7 44 24 04 e9 4b 00 	movl   $0x4be9,0x4(%esp)
    157f:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1598:	00 
    1599:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    15a0:	00 
    ...
    15b1:	c7 44 24 04 fa 4b 00 	movl   $0x4bfa,0x4(%esp)
    15b8:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    15d5:	c7 44 24 04 83 4b 00 	movl   $0x4b83,0x4(%esp)
    15dc:	00 
    15dd:	c7 04 24 83 4b 00 00 	movl   $0x4b83,(%esp)
    15e4:	e8 8f 26 00 00       	call   3c78 <link>
    15e9:	85 c0                	test   %eax,%eax
    15eb:	78 19                	js     1606 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15ed:	c7 44 24 04 0b 4c 00 	movl   $0x4c0b,0x4(%esp)
    15f4:	00 
  ...
  unlink("lf2");
    1606:	c7 04 24 83 4b 00 00 	movl   $0x4b83,(%esp)
    160d:	e8 56 26 00 00       	call   3c68 <unlink>
  if(link("lf2", "lf1") >= 0){
    1612:	c7 44 24 04 7f 4b 00 	movl   $0x4b7f,0x4(%esp)
    1619:	00 
    161a:	c7 04 24 83 4b 00 00 	movl   $0x4b83,(%esp)
    1621:	e8 52 26 00 00       	call   3c78 <link>
    1626:	85 c0                	test   %eax,%eax
    1628:	78 19                	js     1643 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    162a:	c7 44 24 04 2c 4c 00 	movl   $0x4c2c,0x4(%esp)
    1631:	00 
  ...
  if(link(".", "lf1") >= 0){
    1643:	c7 44 24 04 7f 4b 00 	movl   $0x4b7f,0x4(%esp)
    164a:	00 
    164b:	c7 04 24 4f 4c 00 00 	movl   $0x4c4f,(%esp)
    1652:	e8 21 26 00 00       	call   3c78 <link>
    1657:	85 c0                	test   %eax,%eax
    1659:	78 19                	js     1674 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    165b:	c7 44 24 04 51 4c 00 	movl   $0x4c51,0x4(%esp)
    1662:	00 
  ...
  printf(1, "linktest ok\n");
    1674:	c7 44 24 04 6d 4c 00 	movl   $0x4c6d,0x4(%esp)
    167b:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1690:	c7 44 24 04 7a 4c 00 	movl   $0x4c7a,0x4(%esp)
    1697:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1703:	c7 04 24 8a 4c 00 00 	movl   $0x4c8a,(%esp)
    ...
    1746:	c7 04 24 8a 4c 00 00 	movl   $0x4c8a,(%esp)
    ...
    1777:	c7 44 24 04 8d 4c 00 	movl   $0x4c8d,0x4(%esp)
    177e:	00 
  ...
  fd = open(".", 0);
    ...
    17db:	00 
    17dc:	c7 04 24 4f 4c 00 00 	movl   $0x4c4f,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    183e:	c7 44 24 04 a9 4c 00 	movl   $0x4ca9,0x4(%esp)
    1845:	00 
    ...
    1870:	c7 44 24 04 c2 4c 00 	movl   $0x4cc2,0x4(%esp)
    1877:	00 
  ...
  if(n != 40){
    ...
    18cb:	c7 44 24 04 e0 4c 00 	movl   $0x4ce0,0x4(%esp)
    18d2:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1905:	79 19                	jns    1920 <concreate+0x296>
      printf(1, "fork failed\n");
    1907:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
    190e:	00 
  ...
  printf(1, "concreate ok\n");
    1a27:	c7 44 24 04 11 4d 00 	movl   $0x4d11,0x4(%esp)
    1a2e:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a43:	c7 44 24 04 1f 4d 00 	movl   $0x4d1f,0x4(%esp)
    1a4a:	00 
    1a4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a52:	e8 69 23 00 00       	call   3dc0 <printf>

  unlink("x");
    1a57:	c7 04 24 86 48 00 00 	movl   $0x4886,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a71:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
    1a78:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1adf:	00 
    1ae0:	c7 04 24 86 48 00 00 	movl   $0x4886,(%esp)
    ...
    1b11:	75 16                	jne    1b29 <linkunlink+0xec>
      link("cat", "x");
    1b13:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
    1b1a:	00 
    1b1b:	c7 04 24 30 4d 00 00 	movl   $0x4d30,(%esp)
    1b22:	e8 51 21 00 00       	call   3c78 <link>
    1b27:	eb 0c                	jmp    1b35 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b29:	c7 04 24 86 48 00 00 	movl   $0x4886,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b55:	c7 44 24 04 34 4d 00 	movl   $0x4d34,0x4(%esp)
    1b5c:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    1bae:	c7 44 24 04 53 4d 00 	movl   $0x4d53,0x4(%esp)
    1bb5:	00 
  ...
  unlink("bd");
    1c48:	c7 04 24 50 4d 00 00 	movl   $0x4d50,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9c:	c7 44 24 04 7d 4d 00 	movl   $0x4d7d,0x4(%esp)
    1ca3:	00 
  ...
  printf(1, "bigdir ok\n");
    1cc2:	c7 44 24 04 92 4d 00 	movl   $0x4d92,0x4(%esp)
    1cc9:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2e:	00 
    1d2f:	c7 04 24 c8 4d 00 00 	movl   $0x4dc8,(%esp)
  ...
  if(fd < 0){
    ...
    1d44:	c7 44 24 04 ce 4d 00 	movl   $0x4dce,0x4(%esp)
    1d4b:	00 
  ...
  write(fd, "ff", 2);
    ...
    1d64:	00 
    1d65:	c7 44 24 04 aa 4d 00 	movl   $0x4daa,0x4(%esp)
    1d6c:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddc:	00 
    1ddd:	c7 04 24 2c 4e 00 00 	movl   $0x4e2c,(%esp)
  ...
  if(fd < 0){
    ...
    1df2:	c7 44 24 04 35 4e 00 	movl   $0x4e35,0x4(%esp)
    1df9:	00 
  ...
  write(fd, "FF", 2);
    ...
    1e12:	00 
    1e13:	c7 44 24 04 4d 4e 00 	movl   $0x4e4d,0x4(%esp)
    1e1a:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e38:	00 
    1e39:	c7 04 24 50 4e 00 00 	movl   $0x4e50,(%esp)
  ...
  if(fd < 0){
    ...
    1e4e:	c7 44 24 04 5c 4e 00 	movl   $0x4e5c,0x4(%esp)
    1e55:	00 
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6e:	00 
    1e6f:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    1e76:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8b:	0f b6 05 c0 8b 00 00 	movzbl 0x8bc0,%eax
    1e92:	3c 66                	cmp    $0x66,%al
    1e94:	74 19                	je     1eaf <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e96:	c7 44 24 04 75 4e 00 	movl   $0x4e75,0x4(%esp)
    1e9d:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1eba:	c7 44 24 04 90 4e 00 	movl   $0x4e90,0x4(%esp)
    1ec1:	00 
    1ec2:	c7 04 24 2c 4e 00 00 	movl   $0x4e2c,(%esp)
    1ec9:	e8 aa 1d 00 00       	call   3c78 <link>
    1ece:	85 c0                	test   %eax,%eax
    1ed0:	74 19                	je     1eeb <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1ed2:	c7 44 24 04 9c 4e 00 	movl   $0x4e9c,0x4(%esp)
    1ed9:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ff0:	00 
    1ff1:	c7 04 24 90 4e 00 00 	movl   $0x4e90,(%esp)
  ...
  if(fd < 0){
    ...
    2006:	c7 44 24 04 5a 4f 00 	movl   $0x4f5a,0x4(%esp)
    200d:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2026:	00 
    2027:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    202e:	00 
    ...
    203f:	c7 44 24 04 72 4f 00 	movl   $0x4f72,0x4(%esp)
    2046:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2189:	c7 44 24 04 49 50 00 	movl   $0x5049,0x4(%esp)
    2190:	00 
    2191:	c7 04 24 b5 4f 00 00 	movl   $0x4fb5,(%esp)
    2198:	e8 db 1a 00 00       	call   3c78 <link>
    219d:	85 c0                	test   %eax,%eax
    219f:	75 19                	jne    21ba <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    21a1:	c7 44 24 04 54 50 00 	movl   $0x5054,0x4(%esp)
    21a8:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21ba:	c7 44 24 04 49 50 00 	movl   $0x5049,0x4(%esp)
    21c1:	00 
    21c2:	c7 04 24 da 4f 00 00 	movl   $0x4fda,(%esp)
    21c9:	e8 aa 1a 00 00       	call   3c78 <link>
    21ce:	85 c0                	test   %eax,%eax
    21d0:	75 19                	jne    21eb <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    21d2:	c7 44 24 04 78 50 00 	movl   $0x5078,0x4(%esp)
    21d9:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21eb:	c7 44 24 04 90 4e 00 	movl   $0x4e90,0x4(%esp)
    21f2:	00 
    21f3:	c7 04 24 c8 4d 00 00 	movl   $0x4dc8,(%esp)
    21fa:	e8 79 1a 00 00       	call   3c78 <link>
    21ff:	85 c0                	test   %eax,%eax
    2201:	75 19                	jne    221c <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2203:	c7 44 24 04 9c 50 00 	movl   $0x509c,0x4(%esp)
    220a:	00 
  ...
  printf(1, "subdir ok\n");
    2408:	c7 44 24 04 e1 51 00 	movl   $0x51e1,0x4(%esp)
    240f:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2424:	c7 44 24 04 ec 51 00 	movl   $0x51ec,0x4(%esp)
    242b:	00 
    242c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2433:	e8 88 19 00 00       	call   3dc0 <printf>

  unlink("bigwrite");
    2438:	c7 04 24 fb 51 00 00 	movl   $0x51fb,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2457:	00 
    2458:	c7 04 24 fb 51 00 00 	movl   $0x51fb,(%esp)
    ...
    246d:	c7 44 24 04 04 52 00 	movl   $0x5204,0x4(%esp)
    2474:	00 
    ...
    2496:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    249d:	00 
    ...
    24c2:	c7 44 24 04 1c 52 00 	movl   $0x521c,0x4(%esp)
    24c9:	00 
    ...
    unlink("bigwrite");
    24f0:	c7 04 24 fb 51 00 00 	movl   $0x51fb,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2510:	c7 44 24 04 2e 52 00 	movl   $0x522e,0x4(%esp)
    2517:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    2569:	c7 44 24 04 51 52 00 	movl   $0x5251,0x4(%esp)
    2570:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    259a:	c7 04 24 c0 8b 00 00 	movl   $0x8bc0,(%esp)
    25a1:	e8 c5 14 00 00       	call   3a6b <memset>
    if(write(fd, buf, 600) != 600){
    25a6:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ad:	00 
    25ae:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    25b5:	00 
    ...
    25c8:	c7 44 24 04 67 52 00 	movl   $0x5267,0x4(%esp)
    25cf:	00 
  ...
  fd = open("bigfile", 0);
    ...
    25fd:	00 
    25fe:	c7 04 24 49 52 00 00 	movl   $0x5249,(%esp)
  ...
  if(fd < 0){
    ...
    2613:	c7 44 24 04 7d 52 00 	movl   $0x527d,0x4(%esp)
    261a:	00 
  ...
  for(i = 0; ; i++){
    ...
    2641:	00 
    2642:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    2649:	00 
    ...
    265e:	c7 44 24 04 92 52 00 	movl   $0x5292,0x4(%esp)
    2665:	00 
  ...
  if(total != 20*600){
    ...
    26a1:	c7 44 24 04 a7 52 00 	movl   $0x52a7,0x4(%esp)
    26a8:	00 
    ...
    26ba:	0f b6 05 c0 8b 00 00 	movzbl 0x8bc0,%eax
    ...
    26d4:	0f b6 05 eb 8c 00 00 	movzbl 0x8ceb,%eax
    ...
    26ec:	74 19                	je     2707 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    26ee:	c7 44 24 04 bb 52 00 	movl   $0x52bb,0x4(%esp)
    26f5:	00 
  ...
  if(total != 20*600){
    ...
    2716:	c7 44 24 04 d4 52 00 	movl   $0x52d4,0x4(%esp)
    271d:	00 
  ...
  unlink("bigfile");
    272f:	c7 04 24 49 52 00 00 	movl   $0x5249,(%esp)
    2736:	e8 2d 15 00 00       	call   3c68 <unlink>

  printf(1, "bigfile test ok\n");
    273b:	c7 44 24 04 ee 52 00 	movl   $0x52ee,0x4(%esp)
    2742:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c4:	00 
    27c5:	c7 04 24 8c 53 00 00 	movl   $0x538c,(%esp)
  ...
  if(fd < 0){
    ...
    27da:	c7 44 24 04 bc 53 00 	movl   $0x53bc,0x4(%esp)
    27e1:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2805:	00 
    2806:	c7 04 24 fc 53 00 00 	movl   $0x53fc,(%esp)
  ...
  if(fd < 0){
    ...
    281b:	c7 44 24 04 2c 54 00 	movl   $0x542c,0x4(%esp)
    2822:	00 
  ...
  printf(1, "fourteen ok\n");
    2891:	c7 44 24 04 05 55 00 	movl   $0x5505,0x4(%esp)
    2898:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    2a09:	c7 44 24 04 cb 55 00 	movl   $0x55cb,0x4(%esp)
    2a10:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a25:	c7 44 24 04 d5 55 00 	movl   $0x55d5,0x4(%esp)
    2a2c:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a40:	00 
    2a41:	c7 04 24 e2 55 00 00 	movl   $0x55e2,(%esp)
  ...
  if(fd < 0){
    ...
    2a56:	c7 44 24 04 ea 55 00 	movl   $0x55ea,0x4(%esp)
    2a5d:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aaa:	00 
    2aab:	c7 04 24 1b 56 00 00 	movl   $0x561b,(%esp)
  ...
  if(fd >= 0){
    ...
    2ac0:	c7 44 24 04 26 56 00 	movl   $0x5626,0x4(%esp)
    2ac7:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ae0:	00 
    2ae1:	c7 04 24 1b 56 00 00 	movl   $0x561b,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2af6:	c7 44 24 04 26 56 00 	movl   $0x5626,0x4(%esp)
    2afd:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    2b61:	c7 44 24 04 1b 56 00 	movl   $0x561b,0x4(%esp)
    2b68:	00 
    2b69:	c7 04 24 7f 56 00 00 	movl   $0x567f,(%esp)
    2b70:	e8 03 11 00 00       	call   3c78 <link>
    2b75:	85 c0                	test   %eax,%eax
    2b77:	75 19                	jne    2b92 <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b79:	c7 44 24 04 88 56 00 	movl   $0x5688,0x4(%esp)
    2b80:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    2bc2:	00 
    2bc3:	c7 04 24 4f 4c 00 00 	movl   $0x4c4f,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd8:	c7 44 24 04 c0 56 00 	movl   $0x56c0,0x4(%esp)
    2bdf:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c27:	c7 44 24 04 df 56 00 	movl   $0x56df,0x4(%esp)
    2c2e:	00 
  ...
  printf(1, "dir vs file OK\n");
    2c4b:	c7 44 24 04 f3 56 00 	movl   $0x56f3,0x4(%esp)
    2c52:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c67:	c7 44 24 04 03 57 00 	movl   $0x5703,0x4(%esp)
    2c6e:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    2cd9:	c7 04 24 42 57 00 00 	movl   $0x5742,(%esp)
    2ce0:	e8 9b 0f 00 00       	call   3c80 <mkdir>
    link("README", "");
    2ce5:	c7 44 24 04 42 57 00 	movl   $0x5742,0x4(%esp)
    2cec:	00 
    2ced:	c7 04 24 7f 56 00 00 	movl   $0x567f,(%esp)
    2cf4:	e8 7f 0f 00 00       	call   3c78 <link>
    fd = open("", O_CREATE);
    2cf9:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2d00:	00 
    2d01:	c7 04 24 42 57 00 00 	movl   $0x5742,(%esp)
    ...
    2d28:	00 
    2d29:	c7 04 24 43 57 00 00 	movl   $0x5743,(%esp)
    ...
    unlink("xx");
    2d49:	c7 04 24 43 57 00 00 	movl   $0x5743,(%esp)
  ...
  chdir("/");
    2d63:	c7 04 24 66 55 00 00 	movl   $0x5566,(%esp)
    2d6a:	e8 19 0f 00 00       	call   3c88 <chdir>
  printf(1, "empty file name OK\n");
    2d6f:	c7 44 24 04 46 57 00 	movl   $0x5746,0x4(%esp)
    2d76:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d8b:	c7 44 24 04 5a 57 00 	movl   $0x575a,0x4(%esp)
    2d92:	00 
    ...
    2dbe:	e8 55 0e 00 00       	call   3c18 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd9:	c7 44 24 04 68 57 00 	movl   $0x5768,0x4(%esp)
    2de0:	00 
  ...
  for(; n > 0; n--){
    ...
    2dfd:	c7 44 24 04 8a 57 00 	movl   $0x578a,0x4(%esp)
    2e04:	00 
  ...
  if(wait() != -1){
    ...
    2e2a:	c7 44 24 04 9e 57 00 	movl   $0x579e,0x4(%esp)
    2e31:	00 
  ...
  printf(1, "fork test OK\n");
    2e43:	c7 44 24 04 b1 57 00 	movl   $0x57b1,0x4(%esp)
    2e4a:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e63:	a1 e4 63 00 00       	mov    0x63e4,%eax
    2e68:	c7 44 24 04 bf 57 00 	movl   $0x57bf,0x4(%esp)
    2e6f:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eb6:	a1 e4 63 00 00       	mov    0x63e4,%eax
    ...
    2ed0:	c7 44 24 04 ca 57 00 	movl   $0x57ca,0x4(%esp)
    2ed7:	00 
  ...
  if(pid < 0){
    ...
    2f0f:	a1 e4 63 00 00       	mov    0x63e4,%eax
    2f14:	c7 44 24 04 e5 57 00 	movl   $0x57e5,0x4(%esp)
    2f1b:	00 
  ...
  if(c != a + 1){
    ...
    2f52:	a1 e4 63 00 00       	mov    0x63e4,%eax
    2f57:	c7 44 24 04 fc 57 00 	movl   $0x57fc,0x4(%esp)
    2f5e:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2fb0:	a1 e4 63 00 00       	mov    0x63e4,%eax
    2fb5:	c7 44 24 04 18 58 00 	movl   $0x5818,0x4(%esp)
    2fbc:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ffb:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3000:	c7 44 24 04 56 58 00 	movl   $0x5856,0x4(%esp)
    3007:	00 
  ...
  if(c != a - 4096){
    ...
    3031:	a1 e4 63 00 00       	mov    0x63e4,%eax
    ...
    3044:	c7 44 24 04 74 58 00 	movl   $0x5874,0x4(%esp)
    304b:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3098:	a1 e4 63 00 00       	mov    0x63e4,%eax
    ...
    30ab:	c7 44 24 04 ac 58 00 	movl   $0x58ac,0x4(%esp)
    30b2:	00 
  ...
  if(*lastaddr == 99){
    ...
    30ca:	a1 e4 63 00 00       	mov    0x63e4,%eax
    30cf:	c7 44 24 04 d4 58 00 	movl   $0x58d4,0x4(%esp)
    30d6:	00 
  ...
  if(c != a){
    ...
    3119:	a1 e4 63 00 00       	mov    0x63e4,%eax
    ...
    312c:	c7 44 24 04 04 59 00 	movl   $0x5904,0x4(%esp)
    3133:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3160:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3165:	c7 44 24 04 cd 48 00 	movl   $0x48cd,0x4(%esp)
    316c:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31e1:	c7 44 24 04 21 48 00 	movl   $0x4821,0x4(%esp)
    31e8:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3244:	00 
    3245:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
    324c:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e5:	a1 e4 63 00 00       	mov    0x63e4,%eax
    32ea:	c7 44 24 04 3e 59 00 	movl   $0x593e,0x4(%esp)
    32f1:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    332b:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3330:	c7 44 24 04 59 59 00 	movl   $0x5959,0x4(%esp)
    3337:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3371:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3376:	c7 44 24 04 67 59 00 	movl   $0x5967,0x4(%esp)
    337d:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e3:	c7 04 24 76 59 00 00 	movl   $0x5976,(%esp)
    33ea:	e8 89 08 00 00       	call   3c78 <link>
    33ef:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f2:	74 1a                	je     340e <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f4:	a1 e4 63 00 00       	mov    0x63e4,%eax
    33f9:	c7 44 24 04 81 59 00 	movl   $0x5981,0x4(%esp)
    3400:	00 
  ...
  printf(stdout, "validate ok\n");
    3421:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3426:	c7 44 24 04 9a 59 00 	movl   $0x599a,0x4(%esp)
    342d:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343e:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3443:	c7 44 24 04 a7 59 00 	movl   $0x59a7,0x4(%esp)
    344a:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    345f:	05 a0 64 00 00       	add    $0x64a0,%eax
    3464:	0f b6 00             	movzbl (%eax),%eax
    3467:	84 c0                	test   %al,%al
    3469:	74 1a                	je     3485 <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    346b:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3470:	c7 44 24 04 b1 59 00 	movl   $0x59b1,0x4(%esp)
    3477:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3493:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3498:	c7 44 24 04 c2 59 00 	movl   $0x59c2,0x4(%esp)
    349f:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34b0:	c7 04 24 cf 59 00 00 	movl   $0x59cf,(%esp)
  ...
  if(pid == 0){
    ...
    34da:	c7 04 85 00 64 00 00 	movl   $0x59dc,0x6400(,%eax,4)
    34e1:	dc 59 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34ed:	7e e8                	jle    34d7 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34ef:	c7 05 7c 64 00 00 00 	movl   $0x0,0x647c
    34f6:	00 00 00 
    printf(stdout, "bigarg test\n");
    34f9:	a1 e4 63 00 00       	mov    0x63e4,%eax
    34fe:	c7 44 24 04 b9 5a 00 	movl   $0x5ab9,0x4(%esp)
    3505:	00 
    3506:	89 04 24             	mov    %eax,(%esp)
    3509:	e8 b2 08 00 00       	call   3dc0 <printf>
    exec("echo", args);
    350e:	c7 44 24 04 00 64 00 	movl   $0x6400,0x4(%esp)
    3515:	00 
    3516:	c7 04 24 e0 44 00 00 	movl   $0x44e0,(%esp)
    351d:	e8 2e 07 00 00       	call   3c50 <exec>
    printf(stdout, "bigarg test ok\n");
    3522:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3527:	c7 44 24 04 c6 5a 00 	movl   $0x5ac6,0x4(%esp)
    352e:	00 
    ...
    353e:	00 
    353f:	c7 04 24 cf 59 00 00 	movl   $0x59cf,(%esp)
    ...
    3564:	a1 e4 63 00 00       	mov    0x63e4,%eax
    3569:	c7 44 24 04 d6 5a 00 	movl   $0x5ad6,0x4(%esp)
    3570:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    358a:	00 
    358b:	c7 04 24 cf 59 00 00 	movl   $0x59cf,(%esp)
  ...
  if(fd < 0){
    ...
    35a0:	a1 e4 63 00 00       	mov    0x63e4,%eax
    35a5:	c7 44 24 04 ef 5a 00 	movl   $0x5aef,0x4(%esp)
    35ac:	00 
  ...
  unlink("bigarg-ok");
    35c5:	c7 04 24 cf 59 00 00 	movl   $0x59cf,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35e1:	c7 44 24 04 04 5b 00 	movl   $0x5b04,0x4(%esp)
    35e8:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36cb:	c7 44 24 04 11 5b 00 	movl   $0x5b11,0x4(%esp)
    36d2:	00 
    ...
    3702:	c7 44 24 04 1d 5b 00 	movl   $0x5b1d,0x4(%esp)
    3709:	00 
    ...
    3726:	00 
    3727:	c7 44 24 04 c0 8b 00 	movl   $0x8bc0,0x4(%esp)
    372e:	00 
    ...
    374e:	c7 44 24 04 2d 5b 00 	movl   $0x5b2d,0x4(%esp)
    3755:	00 
  ...
  printf(1, "fsfull test finished\n");
    3872:	c7 44 24 04 3d 5b 00 	movl   $0x5b3d,0x4(%esp)
    3879:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    388f:	a1 e8 63 00 00       	mov    0x63e8,%eax
    3894:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    389a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    389f:	a3 e8 63 00 00       	mov    %eax,0x63e8
  return randstate;
    38a4:	a1 e8 63 00 00       	mov    0x63e8,%eax
}
    38a9:	5d                   	pop    %ebp
    38aa:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    38b4:	c7 44 24 04 53 5b 00 	movl   $0x5b53,0x4(%esp)
    38bb:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3900:	00 
    3901:	c7 04 24 67 5b 00 00 	movl   $0x5b67,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d59:	0f b6 80 ec 63 00 00 	movzbl 0x63ec(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3eb6:	75 09                	jne    3ec1 <printf+0x101>
          s = "(null)";
    3eb8:	c7 45 f4 a2 5b 00 00 	movl   $0x5ba2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f82:	a1 88 64 00 00       	mov    0x6488,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    404d:	a3 88 64 00 00       	mov    %eax,0x6488
}
    4052:	c9                   	leave  
    4053:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    40a5:	a1 88 64 00 00       	mov    0x6488,%eax
}
    40aa:	c9                   	leave  
    40ab:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40c1:	a1 88 64 00 00       	mov    0x6488,%eax
    40c6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40c9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40cd:	75 23                	jne    40f2 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40cf:	c7 45 f0 80 64 00 00 	movl   $0x6480,-0x10(%ebp)
    40d6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d9:	a3 88 64 00 00       	mov    %eax,0x6488
    40de:	a1 88 64 00 00       	mov    0x6488,%eax
    40e3:	a3 80 64 00 00       	mov    %eax,0x6480
    base.s.size = 0;
    40e8:	c7 05 84 64 00 00 00 	movl   $0x0,0x6484
    40ef:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4145:	a3 88 64 00 00       	mov    %eax,0x6488
      return (void*)(p + 1);
    ...
    if(p == freep)
    4152:	a1 88 64 00 00       	mov    0x6488,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    4230:	c7 44 24 04 a9 5b 00 	movl   $0x5ba9,0x4(%esp)
    4237:	00 
    ...
    4275:	c7 44 24 04 b7 5b 00 	movl   $0x5bb7,0x4(%esp)
    427c:	00 
    ...
    42a1:	c7 44 24 04 c4 5b 00 	movl   $0x5bc4,0x4(%esp)
    42a8:	00 
...
sem_signal(struct semaphore * s){
    ...
    447c:	7d 0f                	jge    448d <sem_signal+0x30>
		s->count++;	
    447e:	8b 45 08             	mov    0x8(%ebp),%eax
    4481:	8b 40 04             	mov    0x4(%eax),%eax
    4484:	8d 50 01             	lea    0x1(%eax),%edx
    ...
    4490:	83 c0 0c             	add    $0xc,%eax
    4493:	89 04 24             	mov    %eax,(%esp)
    4496:	e8 bd fe ff ff       	call   4358 <pop_q>
    449b:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if(tid != -1){
    449e:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    44a2:	74 2e                	je     44d2 <sem_signal+0x75>
		//printf(1, "Sem A\n");
		twakeup(tid);
    44a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44a7:	89 04 24             	mov    %eax,(%esp)
    44aa:	e8 21 f8 ff ff       	call   3cd0 <twakeup>
		s->count--;
    44af:	8b 45 08             	mov    0x8(%ebp),%eax
    44b2:	8b 40 04             	mov    0x4(%eax),%eax
    44b5:	8d 50 ff             	lea    -0x1(%eax),%edx
    44b8:	8b 45 08             	mov    0x8(%ebp),%eax
    44bb:	89 50 04             	mov    %edx,0x4(%eax)
		if(s->count < 0) s->count = 0;
    44be:	8b 45 08             	mov    0x8(%ebp),%eax
    44c1:	8b 40 04             	mov    0x4(%eax),%eax
    44c4:	85 c0                	test   %eax,%eax
    44c6:	79 0a                	jns    44d2 <sem_signal+0x75>
    44c8:	8b 45 08             	mov    0x8(%ebp),%eax
    44cb:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	}
	lock_release(&s->lock);
    44d2:	8b 45 08             	mov    0x8(%ebp),%eax
    44d5:	89 04 24             	mov    %eax,(%esp)
    44d8:	e8 f7 fc ff ff       	call   41d4 <lock_release>
