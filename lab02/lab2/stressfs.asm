...
main(int argc, char *argv[])
{
  ...
  2c:	c7 44 24 04 ea 0c 00 	movl   $0xcea,0x4(%esp)
  33:	00 
  ...
  91:	c7 44 24 04 fd 0c 00 	movl   $0xcfd,0x4(%esp)
  98:	00 
...
//    printf(fd, "%d\n", i);
 ...
 125:	e8 19 03 00 00       	call   443 <close>
  ...
  printf(1, "read\n");
 12a:	c7 44 24 04 07 0d 00 	movl   $0xd07,0x4(%esp)
 131:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 55c:	0f b6 80 04 11 00 00 	movzbl 0x1104(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6b9:	75 09                	jne    6c4 <printf+0x101>
          s = "(null)";
 6bb:	c7 45 f4 0d 0d 00 00 	movl   $0xd0d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 785:	a1 20 11 00 00       	mov    0x1120,%eax
...
free(void *ap)
{
 ...
 850:	a3 20 11 00 00       	mov    %eax,0x1120
}
 855:	c9                   	leave  
 856:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8a3:	e8 ce fe ff ff       	call   776 <free>
  return freep;
 8a8:	a1 20 11 00 00       	mov    0x1120,%eax
}
 8ad:	c9                   	leave  
 8ae:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8c1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8c4:	a1 20 11 00 00       	mov    0x1120,%eax
 8c9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8cc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8d0:	75 23                	jne    8f5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8d2:	c7 45 f0 18 11 00 00 	movl   $0x1118,-0x10(%ebp)
 8d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8dc:	a3 20 11 00 00       	mov    %eax,0x1120
 8e1:	a1 20 11 00 00       	mov    0x1120,%eax
 8e6:	a3 18 11 00 00       	mov    %eax,0x1118
    base.s.size = 0;
 8eb:	c7 05 1c 11 00 00 00 	movl   $0x0,0x111c
 8f2:	00 00 00 
  }
 ...
 948:	a3 20 11 00 00       	mov    %eax,0x1120
      return (void*)(p + 1);
 ...
 953:	eb 38                	jmp    98d <malloc+0xde>
    ...
    if(p == freep)
 955:	a1 20 11 00 00       	mov    0x1120,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 a33:	c7 44 24 04 14 0d 00 	movl   $0xd14,0x4(%esp)
 a3a:	00 
 ...
 a78:	c7 44 24 04 22 0d 00 	movl   $0xd22,0x4(%esp)
 a7f:	00 
 ...
 aa4:	c7 44 24 04 2f 0d 00 	movl   $0xd2f,0x4(%esp)
 aab:	00 
...
sem_aquire(struct semaphore * s){
 ...
 c13:	75 2f                	jne    c44 <sem_aquire+0x4a>
		//add proc to waiters list
		int tid = getpid();
 c15:	e8 81 f8 ff ff       	call   49b <getpid>
 ...
 c20:	8d 50 0c             	lea    0xc(%eax),%edx
 c23:	8b 45 f4             	mov    -0xc(%ebp),%eax
 c26:	89 44 24 04          	mov    %eax,0x4(%esp)
 c2a:	89 14 24             	mov    %edx,(%esp)
 c2d:	e8 af fe ff ff       	call   ae1 <add_q>
		//printf(1, "		Added to waiters semaphore with size: %d\n", s->size);
		lock_release(&s->lock);
 c32:	8b 45 08             	mov    0x8(%ebp),%eax
 c35:	89 04 24             	mov    %eax,(%esp)
 c38:	e8 9a fd ff ff       	call   9d7 <lock_release>
		tsleep(); 
 c3d:	e8 89 f8 ff ff       	call   4cb <tsleep>
 c42:	eb 1a                	jmp    c5e <sem_aquire+0x64>
	}
	else{
		s->count--;	
 ...
 c59:	e8 79 fd ff ff       	call   9d7 <lock_release>
	}
}
 c5e:	c9                   	leave  
 c5f:	c3                   	ret    
...
sem_signal(struct semaphore * s){
 ...
 cba:	e8 18 fd ff ff       	call   9d7 <lock_release>
 cbf:	eb 27                	jmp    ce8 <sem_signal+0x88>
	}
	else{
		int tid;
		tid = pop_q(&s->waiters);
 ...
 cca:	e8 8c fe ff ff       	call   b5b <pop_q>
 ccf:	89 45 f0             	mov    %eax,-0x10(%ebp)
		twakeup(tid);
 cd2:	8b 45 f0             	mov    -0x10(%ebp),%eax
 cd5:	89 04 24             	mov    %eax,(%esp)
 cd8:	e8 f6 f7 ff ff       	call   4d3 <twakeup>
		lock_release(&s->lock);
 cdd:	8b 45 08             	mov    0x8(%ebp),%eax
 ce0:	89 04 24             	mov    %eax,(%esp)
 ce3:	e8 ef fc ff ff       	call   9d7 <lock_release>
	}
