...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 49 0c 00 00 	movl   $0xc49,(%esp)
  ...
  30:	00 
  31:	c7 04 24 49 0c 00 00 	movl   $0xc49,(%esp)
  38:	e8 82 03 00 00       	call   3bf <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 49 0c 00 00 	movl   $0xc49,(%esp)
  ...
  69:	c7 44 24 04 51 0c 00 	movl   $0xc51,0x4(%esp)
  70:	00 
  ...
  8d:	c7 44 24 04 64 0c 00 	movl   $0xc64,0x4(%esp)
  94:	00 
  ...
  ab:	75 2d                	jne    da <main+0xda>
      exec("sh", argv);
  ad:	c7 44 24 04 90 10 00 	movl   $0x1090,0x4(%esp)
  b4:	00 
  b5:	c7 04 24 46 0c 00 00 	movl   $0xc46,(%esp)
  bc:	e8 ee 02 00 00       	call   3af <exec>
      printf(1, "init: exec sh failed\n");
  c1:	c7 44 24 04 77 0c 00 	movl   $0xc77,0x4(%esp)
  c8:	00 
  ...
  da:	eb 14                	jmp    f0 <main+0xf0>
      printf(1, "zombie!\n");
  dc:	c7 44 24 04 8d 0c 00 	movl   $0xc8d,0x4(%esp)
  e3:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b8:	0f b6 80 98 10 00 00 	movzbl 0x1098(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 615:	75 09                	jne    620 <printf+0x101>
          s = "(null)";
 617:	c7 45 f4 96 0c 00 00 	movl   $0xc96,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 b4 10 00 00       	mov    0x10b4,%eax
...
free(void *ap)
{
 ...
 7ac:	a3 b4 10 00 00       	mov    %eax,0x10b4
}
 7b1:	c9                   	leave  
 7b2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ff:	e8 ce fe ff ff       	call   6d2 <free>
  return freep;
 804:	a1 b4 10 00 00       	mov    0x10b4,%eax
}
 809:	c9                   	leave  
 80a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 81d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 820:	a1 b4 10 00 00       	mov    0x10b4,%eax
 825:	89 45 f0             	mov    %eax,-0x10(%ebp)
 828:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 82c:	75 23                	jne    851 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 82e:	c7 45 f0 ac 10 00 00 	movl   $0x10ac,-0x10(%ebp)
 835:	8b 45 f0             	mov    -0x10(%ebp),%eax
 838:	a3 b4 10 00 00       	mov    %eax,0x10b4
 83d:	a1 b4 10 00 00       	mov    0x10b4,%eax
 842:	a3 ac 10 00 00       	mov    %eax,0x10ac
    base.s.size = 0;
 847:	c7 05 b0 10 00 00 00 	movl   $0x0,0x10b0
 84e:	00 00 00 
  }
 ...
 8a4:	a3 b4 10 00 00       	mov    %eax,0x10b4
      return (void*)(p + 1);
 ...
 8af:	eb 38                	jmp    8e9 <malloc+0xde>
    ...
    if(p == freep)
 8b1:	a1 b4 10 00 00       	mov    0x10b4,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 98f:	c7 44 24 04 9d 0c 00 	movl   $0xc9d,0x4(%esp)
 996:	00 
 ...
 9d4:	c7 44 24 04 ab 0c 00 	movl   $0xcab,0x4(%esp)
 9db:	00 
 ...
 a00:	c7 44 24 04 b8 0c 00 	movl   $0xcb8,0x4(%esp)
 a07:	00 
